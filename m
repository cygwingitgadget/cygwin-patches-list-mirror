Return-Path: <cygwin-patches-return-3663-listarch-cygwin-patches=sources.redhat.com@cygwin.com>
Received: (qmail 25392 invoked by alias); 2 Mar 2003 12:51:24 -0000
...
Received: (qmail 25361 invoked from network); 2 Mar 2003 12:51:23 -0000
From: "Chris January" <chris@atomice.net>
To: "Cygwin-Patches@Cygwin.Com" <cygwin-patches@cygwin.com>
Subject: PATCH: Implements /proc/cpuinfo and /proc/partitions
Date: Sun, 02 Mar 2003 12:51:00 -0000
Message-ID: <LPEHIHGCJOAIPFLADJAHAEADDGAA.chris@atomice.net>
MIME-Version: 1.0
Content-Type: multipart/mixed;
	boundary="----=_NextPart_000_000E_01C2E0BA.5ADC2170"
X-Priority: 3 (Normal)
X-MSMail-Priority: Normal
Importance: Normal
X-MimeOLE: Produced By Microsoft MimeOLE V6.00.2800.1106
X-SW-Source: 2003-q1/txt/msg00312.txt.bz2

This is a multi-part message in MIME format.

------=_NextPart_000_000E_01C2E0BA.5ADC2170
...
diff -b -B -u -p -r1.63 autoload.cc=0A=
--- cygwin/autoload.cc	21 Feb 2003 14:29:17 -0000	1.63=0A=
+++ cygwin/autoload.cc	2 Mar 2003 12:39:50 -0000=0A=
...
diff -b -B -u -p -r1.20 fhandler_proc.cc=0A=
--- cygwin/fhandler_proc.cc	10 Jan 2003 12:32:46 -0000	1.20=0A=
+++ cygwin/fhandler_proc.cc	2 Mar 2003 12:39:51 -0000=0A=
...
@@ -405,10 +428,16 @@ format_proc_uptime (char *destbuf, size_=0A=
...
@@ -417,12 +446,11 @@ format_proc_uptime (char *destbuf, size_=0A=
...
@@ -503,3 +531,402 @@ format_proc_stat (char *destbuf, size_t=20=0A=
 			  context_switches,=0A=
 			  boot_time);=0A=
 }=0A=
+=0A=
...
+          bufptr +=3D __small_sprintf (bufptr, "processor       : %d\n", c=
pu_number);=0A=
+          unsigned maxf, vendor_id[4], unused, cpuid_sig, extra_info, feat=
ures;=0A=
...
+          if (maxf >=3D 1)=0A=
+            {=0A=
+              unsigned cpuid_sig, extra_info, features2, features1;=0A=
+              cpuid (&cpuid_sig, &extra_info, &features2, &features1, 1);=
=0A=
+              unsigned extended_family =3D (cpuid_sig & 0x0ff00000) >> 20,=
=0A=
+                       extended_model  =3D (cpuid_sig & 0x000f0000) >> 16,=
=0A=
+                       type            =3D (cpuid_sig & 0x00003000) >> 12,=
=0A=
...
ION *) buf;=0A=
+                  for (int partition =3D 0; partition < dli->PartitionCoun=
t; partition++)=0A=
+                    {=0A=
