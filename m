...
Received: from conuserg-12.nifty.com (conuserg-12.nifty.com [210.131.2.79])
	by sourceware.org (Postfix) with ESMTPS id CE1813858421
	for <cygwin-patches@cygwin.com>; Tue, 20 Dec 2022 12:46:15 +0000 (GMT)
DMARC-Filter: OpenDMARC Filter v1.4.1 sourceware.org CE1813858421
...
Received: from localhost.localdomain (aj135041.dynamic.ppp.asahi-net.or.jp [220.150.135.41]) (authenticated)
	by conuserg-12.nifty.com with ESMTP id 2BKCjWbF003055;
	Tue, 20 Dec 2022 21:45:37 +0900
DKIM-Filter: OpenDKIM Filter v2.10.3 conuserg-12.nifty.com 2BKCjWbF003055
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=nifty.ne.jp;
	s=dec2015msa; t=1671540337;
	bh=NDqC3Ab21wfm1QQGqP/NdZaggsNAaL0325OfeIPRMx8=;
	h=From:To:Cc:Subject:Date:From;
	b=
X-Nifty-SrcIP: [220.150.135.41]
From: Takashi Yano <takashi.yano@nifty.ne.jp>
To: cygwin-patches@cygwin.com
Cc: Takashi Yano <takashi.yano@nifty.ne.jp>
Subject: [PATCH] Cygwin: console: Make the console accessible from other terminals.
Date: Tue, 20 Dec 2022 21:45:21 +0900
Message-Id: <20221220124521.499-1-takashi.yano@nifty.ne.jp>
X-Mailer: git-send-email 2.39.0
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
X-Spam-Status: No, score=-8.1 required=5.0 tests=BAYES_00,DKIM_SIGNED,DKIM_VALID,DKIM_VALID_AU,DKIM_VALID_EF,GIT_PATCH_0,KAM_SOMETLD_ARE_BAD_TLD,RCVD_IN_DNSWL_NONE,SPF_HELO_NONE,SPF_PASS,TXREP,T_PDS_OTHER_BAD_TLD autolearn=ham autolearn_force=no version=3.4.6
