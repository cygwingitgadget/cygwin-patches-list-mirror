Return-Path: <cygwin-patches-return-9118-listarch-cygwin-patches=sources.redhat.com@cygwin.com>
Received: (qmail 52322 invoked by alias); 15 Jul 2018 08:20:58 -0000
...
Received: (qmail 52087 invoked by uid 89); 15 Jul 2018 08:20:57 -0000
Authentication-Results: sourceware.org; auth=none
X-Spam-SWARE-Status: No, score=-21.9 required=5.0 tests=AWL,BAYES_20,GIT_PATCH_0,GIT_PATCH_1,GIT_PATCH_2,GIT_PATCH_3,KAM_LAZY_DOMAIN_SECURITY autolearn=ham version=3.3.2 spammy=chicken, wanting, incurred, capture
...
Received: (from daemon@localhost)	by m0.truegem.net (8.12.11/8.12.11) id w6F8Kodc071065;	Sun, 15 Jul 2018 01:20:50 -0700 (PDT)	(envelope-from mark@maxrnd.com)
Received: from 76-217-5-154.lightspeed.irvnca.sbcglobal.net(76.217.5.154), claiming to be "localhost.localdomain" via SMTP by m0.truegem.net, id smtpdGBjRmR; Sun Jul 15 01:20:45 2018
From: Mark Geisert <mark@maxrnd.com>
To: cygwin-patches@cygwin.com
Cc: Mark Geisert <mark@maxrnd.com>
Subject: [PATCH v3 1/3] POSIX Asynchronous I/O support: aio files
Date: Sun, 15 Jul 2018 08:20:00 -0000
Message-Id: <20180715082025.4920-2-mark@maxrnd.com>
In-Reply-To: <20180715082025.4920-1-mark@maxrnd.com>
References: <20180715082025.4920-1-mark@maxrnd.com>
X-IsSubscribed: yes
X-SW-Source: 2018-q3/txt/msg00012.txt.bz2
