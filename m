...
Received: from mail231.csoft.net (mail231.csoft.net [66.216.5.135])
	by sourceware.org (Postfix) with ESMTPS id C23AE3858D39
	for <cygwin-patches@cygwin.com>; Fri, 25 Jul 2025 18:51:54 +0000 (GMT)
DMARC-Filter: OpenDMARC Filter v1.4.2 sourceware.org C23AE3858D39
Authentication-Results: sourceware.org; dmarc=pass (p=reject dis=none) header.from=jdrake.com
Authentication-Results: sourceware.org; spf=pass smtp.mailfrom=jdrake.com
ARC-Filter: OpenARC Filter v1.0.0 sourceware.org C23AE3858D39
Authentication-Results: server2.sourceware.org; arc=none smtp.remote-ip=66.216.5.135
ARC-Seal: i=1; a=rsa-sha256; d=sourceware.org; s=key; t=1753469514; cv=none;
	b=dpRXNKS0UFzxaChIjH64OG4cetUPFjqSYbR/mFsrtX6CX7cBosU0SGMxnSYRoSJmM4m2myOky0LqMZzW0v+bwYuAqdwbLfL0EVp8lw1XEw77m9RODPa6/SRLA89Vw2xsAvxXJshGhpRSLG84RAfKeQ+xMfQ+HFZxnfoCn7dVZco=
ARC-Message-Signature: i=1; a=rsa-sha256; d=sourceware.org; s=key;
	t=1753469514; c=relaxed/simple;
	bh=VBgUGiL/nHDX9DtLVsHv3JMvOczs2Kf3hq3XS7DyWIk=;
	h=DKIM-Signature:Date:From:To:Subject:Message-ID:MIME-Version; b=wjfq2q1BAqbypWQGjofFNd/fgy0CHAXA6ysfy7iL+yqf6AEVCP5OgaTQoPs4XHOvV42u4EQB0j8HG1yka/zlvwWuxflgdUzkFsP4cpxmKa/+tI1fsMOldf1lFIYZzkUSRszjhpc0Bx/nwqSZX2mnLIYep8lYx2eykPMiWLtQHfo=
ARC-Authentication-Results: i=1; server2.sourceware.org
DKIM-Filter: OpenDKIM Filter v2.11.0 sourceware.org C23AE3858D39
Authentication-Results: sourceware.org;
	dkim=pass (1024-bit key, unprotected) header.d=jdrake.com header.i=@jdrake.com header.a=rsa-sha1 header.s=csoft header.b=JRdzpCjd
Received: from mail231.csoft.net (localhost [127.0.0.1])
	by mail231.csoft.net (Postfix) with ESMTP id 6D83745CD2;
	Fri, 25 Jul 2025 14:51:54 -0400 (EDT)
DKIM-Signature: v=1; a=rsa-sha1; c=relaxed; d=jdrake.com; h=date:from:to
	:cc:subject:in-reply-to:message-id:references:mime-version
	:content-type; s=csoft; bh=F8BGA6Ut6oD1gpQSvb4WgvYYtng=; b=JRdzp
	CjdQqeHVHvnIROvVkwZuyM2NfkVz57+tmxyRlcfsUUk6o/FKYy9BMDzpcSQngOqv
	tdi0aWD60BqZYtKMM8vRNWMJIsDBHYBeHauLkTIS/dhp6K6uEm1XR5YfgA1+9Az9
	MaAJFknuWI0qDg/PnjZslj9cL7S7dG+BZN+h4w=
Received: from mail231 (mail231 [66.216.5.135])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature ECDSA (prime256v1) server-digest SHA256)
	(No client certificate requested)
	(Authenticated sender: jeremyd)
	by mail231.csoft.net (Postfix) with ESMTPSA id 5697345CC6;
	Fri, 25 Jul 2025 14:51:54 -0400 (EDT)
Date: Fri, 25 Jul 2025 11:51:54 -0700 (PDT)
From: Jeremy Drake <cygwin@jdrake.com>
X-X-Sender: jeremyd@resin.csoft.net
To: Radek Barton <radek.barton@microsoft.com>
cc: "cygwin-patches@cygwin.com" <cygwin-patches@cygwin.com>
Subject: Re: [PATCH v4] Cygwin: mkimport: implement AArch64 +/-4GB
 relocations
In-Reply-To:  <DB9PR83MB092391AD95379EB112A8EC339259A@DB9PR83MB0923.EURPRD83.prod.outlook.com>
Message-ID: <62741773-3864-2deb-c26c-4ae3dcea9344@jdrake.com>
...
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="12017318494208-2120660041-1753469514=:74162"
...
--12017318494208-2120660041-1753469514=:74162
...
> Hello.
>
> Sending another version with suggestion to use more strict conditions f=
or instructions detection applied.
...
> Subject: [PATCH v4] Cygwin: mkimport: implement AArch64 +/-4GB relocati=
ons
> MIME-Version: 1.0
