...
Received: from smtp-out-no.shaw.ca (smtp-out-no.shaw.ca [64.59.134.12])
 by sourceware.org (Postfix) with ESMTPS id 5663E3858009
 for <cygwin-patches@cygwin.com>; Mon, 23 Nov 2020 22:11:10 +0000 (GMT)
DMARC-Filter: OpenDMARC Filter v1.3.2 sourceware.org 5663E3858009
...
Received: from BWINGLISD.cg.shawcable.net ([24.64.172.44])
 ...
 id hK37kKOHT34axhK3Bk8h5A; Mon, 23 Nov 2020 15:11:09 -0700
X-Authority-Analysis: v=2.4 cv=LvQsdlRc c=1 sm=1 tr=0 ts=5fbc337d
 a=kiZT5GMN3KAWqtYcXc+/4Q==:117 a=kiZT5GMN3KAWqtYcXc+/4Q==:17
 a=r77TgQKjGQsHNAKrUKIA:9 a=s70SRmmLsFUBM0mfSQcA:9 a=QEXdDO2ut3YA:10
 a=pGLkceISAAAA:8 a=sfbv-ZumAAAA:8 a=mDV3o1hIAAAA:8 a=w_pzkKWiAAAA:8
 a=oQEXGHOFuNUCwZ8INYQA:9 a=-3MyG8t3HYu4En9A:21 a=wO6sfZb2l6OdIZre:21
 a=SAsfXE3_tGzuuUc-:21 a=IfQ-iFkkCvMA:10 a=B2y7HmGcmWMA:10
 a=h09z5sUpd3mrlY95TnZs:22 a=_FVE-zBwftR9WsbkzFJk:22 a=sRI3_1zDfAgwuvI8zelB:22
 a=pHzHmUro8NiASowvMSCR:22 a=nt3jZW36AmriUCFCBwmW:22
From: Brian Inglis <Brian.Inglis@SystematicSW.ab.ca>
To: cygwin-patches@cygwin.com
Subject: [PATCH 1/2] specialnames.xml: add proc(5) Cygwin man page
Date: Mon, 23 Nov 2020 15:11:00 -0700
Message-Id: <20201123221101.16864-2-Brian.Inglis@SystematicSW.ab.ca>
...
X-CMAE-Envelope: 
X-Spam-Status: No, score=-12.1 required=5.0 tests=BAYES_00, GIT_PATCH_0,
 KAM_DMARC_STATUS, KAM_LAZY_DOMAIN_SECURITY, KAM_LOTSOFHASH, KAM_SHORT,
...
X-List-Received-Date: Mon, 23 Nov 2020 22:11:16 -0000
...
--------------2.29.2
Content-Type: text/x-patch; name="0001-specialnames.xml-add-proc-5-Cygwin-man-page.patch"
Content-Transfer-Encoding: 8bit
Content-Disposition: attachment; filename="0001-specialnames.xml-add-proc-5-Cygwin-man-page.patch"
...
+	      </para>
+
+	      <para>The <filename>/proc/[pid]</filename> subdirectories are
...
+		to the process's own <filename>/proc/[pid]</filename> directory.
+	      </para>
+
+	    </listitem>
+	  </varlistentry>
...
+		Each <filename>/proc/[pid]</filename> subdirectory
+		contains the pseudo-files and directories described below.
+	      </para>
+
+	      <para>The files inside each <filename>/proc/[pid]</filename>
...
+	        You can even type <filename>/proc/[pid]/exe</filename>
+	        to run another copy of the same executable that is being run by
+	        process [pid].
+		<filename>/proc/[pid]/exe</filename> is a pointer to
...
+		<filename>/proc/[pid]/fd</filename> files as command-line
+		arguments.
...
+		<filename>/proc/[pid]/fd</filename> entry, and that the
...
+		      (same as VmSize in <filename>/proc/[pid]/status</filename>)</para>
+		    </listitem>
+		  </varlistentry>
+		  <varlistentry>
...
+		      (same as VmRSS in <filename>/proc/[pid]/status</filename>)</para>
+		    </listitem>
+		  </varlistentry>
+		  <varlistentry>
+		    <term>(3) shared</term>
...
+		      <filename>/proc/[pid]/status</filename>)</para>
+		    </listitem>
+		  </varlistentry>
+		  <varlistentry>
+		    <term>(4) text</term>
...
+	  </varlistentry>
+	  <varlistentry>
+	    <term><filename>/proc/[pid]/status</filename></term>
+	    <listitem>
+	      <para>
+		Provides much of the information in
+		<filename>/proc/[pid]/stat</filename> and
