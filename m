...
Received: from dmta0013.nifty.com (mta-snd00005.nifty.com [106.153.226.37])
	by sourceware.org (Postfix) with ESMTPS id 678913858D35
	for <cygwin-patches@cygwin.com>; Mon, 28 Aug 2023 13:23:44 +0000 (GMT)
DMARC-Filter: OpenDMARC Filter v1.4.2 sourceware.org 678913858D35
Authentication-Results: sourceware.org; dmarc=fail (p=none dis=none) header.from=nifty.ne.jp
Authentication-Results: sourceware.org; spf=fail smtp.mailfrom=nifty.ne.jp
Received: from HP-Z230 by dmta0013.nifty.com with ESMTP
          id <20230828132342567.NAFB.104052.HP-Z230@nifty.com>
          for <cygwin-patches@cygwin.com>; Mon, 28 Aug 2023 22:23:42 +0900
Date: Mon, 28 Aug 2023 22:23:42 +0900
From: Takashi Yano <takashi.yano@nifty.ne.jp>
To: cygwin-patches@cygwin.com
Subject: Re: [PATCH v2] Cygwin: spawn: Fix segfalt when too many command
 line args are specified.
Message-Id: <20230828222342.75952c8a6af7fc67033c23c4@nifty.ne.jp>
...
References: <20230828094605.2405-1-takashi.yano@nifty.ne.jp>
	...
	<20230828212709.0d1f2703dbc10c8ae96da3ac@nifty.ne.jp>
X-Mailer: Sylpheed 3.7.0 (GTK+ 2.24.30; i686-pc-mingw32)
Mime-Version: 1.0
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: 7bit
X-Spam-Status: No, score=-11.9 required=5.0 tests=BAYES_00,GIT_PATCH_0,KAM_DMARC_STATUS,NICE_REPLY_A,RCVD_IN_DNSWL_NONE,SPF_HELO_PASS,SPF_PASS,TXREP autolearn=ham autolearn_force=no version=3.4.6
