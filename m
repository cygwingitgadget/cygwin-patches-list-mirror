Return-Path: <cygwin-patches-return-9142-listarch-cygwin-patches=sources.redhat.com@cygwin.com>
Received: (qmail 57376 invoked by alias); 24 Jul 2018 05:32:29 -0000
...
Received: (qmail 56682 invoked by uid 89); 24 Jul 2018 05:32:28 -0000
Authentication-Results: sourceware.org; auth=none
X-Spam-SWARE-Status: No, score=-23.7 required=5.0 tests=AWL,BAYES_00,GIT_PATCH_0,GIT_PATCH_1,GIT_PATCH_2,GIT_PATCH_3,KAM_LAZY_DOMAIN_SECURITY autolearn=ham version=3.3.2 spammy=pipes, worst, cancellation, events
X-HELO: m0.truegem.net
Received: from m0.truegem.net (HELO m0.truegem.net) (69.55.228.47) by sourceware.org (qpsmtpd/0.93/v0.84-503-g423c35a) with ESMTP; Tue, 24 Jul 2018 05:32:24 +0000
Received: (from daemon@localhost)	by m0.truegem.net (8.12.11/8.12.11) id w6O5WNBH095194;	Mon, 23 Jul 2018 22:32:23 -0700 (PDT)	(envelope-from mark@maxrnd.com)
Received: from 76-217-5-154.lightspeed.irvnca.sbcglobal.net(76.217.5.154), claiming to be "localhost.localdomain" via SMTP by m0.truegem.net, id smtpdjoqEAf; Mon Jul 23 22:32:20 2018
From: Mark Geisert <mark@maxrnd.com>
To: cygwin-patches@cygwin.com
Cc: Mark Geisert <mark@maxrnd.com>
Subject: [PATCH final 1/3] POSIX Asynchronous I/O support: aio files
Date: Tue, 24 Jul 2018 05:32:00 -0000
Message-Id: <20180724053159.2676-2-mark@maxrnd.com>
In-Reply-To: <20180724053159.2676-1-mark@maxrnd.com>
References: <20180724053159.2676-1-mark@maxrnd.com>
X-IsSubscribed: yes
X-SW-Source: 2018-q3/txt/msg00037.txt.bz2
