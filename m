...
Received: from nihsmtpxwayst06.hub.nih.gov (nihsmtpxwayst06.hub.nih.gov
 [165.112.13.57])
 by sourceware.org (Postfix) with ESMTPS id 6D671385802C
 for <cygwin-patches@cygwin.com>; Tue, 18 Jan 2022 16:09:49 +0000 (GMT)
DMARC-Filter: OpenDMARC Filter v1.4.1 sourceware.org 6D671385802C
X-SBRS-Extended: Low
X-IronPortListener: non-ces-out
X-IronPortListener: non-ces-out
X-IronPort-AV: E=Sophos;i="5.88,297,1635220800"; d="scan'208";a="91015874"
Received: from msg-b12-ltm1_v9.hub.nih.gov (HELO mail2.ncbi.nlm.nih.gov)
 ...
 18 Jan 2022 11:09:49 -0500
Received: from mail1.ncbi.nlm.nih.gov (vhod23.be-md.ncbi.nlm.nih.gov
 [130.14.26.86])
 by mail2.ncbi.nlm.nih.gov (Postfix) with ESMTP id E799D1A0002;
 Tue, 18 Jan 2022 11:09:48 -0500 (EST)
From: Anton Lavrentiev <lavr@ncbi.nlm.nih.gov>
To: cygwin-patches@cygwin.com
Subject: [PATCH] Cygwin: resolver: Process options forward (not backwards)
Date: Tue, 18 Jan 2022 11:09:33 -0500
Message-Id: <20220118160933.2106-1-lavr@ncbi.nlm.nih.gov>
...
X-List-Received-Date: Tue, 18 Jan 2022 16:09:50 -0000
