...
Received: from re-prd-fep-041.btinternet.com (mailomta22-re.btinternet.com
 [213.120.69.115])
 by sourceware.org (Postfix) with ESMTPS id 2DDA1386103D
 for <cygwin-patches@cygwin.com>; Wed, 21 Oct 2020 19:47:28 +0000 (GMT)
DMARC-Filter: OpenDMARC Filter v1.3.2 sourceware.org 2DDA1386103D
...
Received: from re-prd-rgout-003.btmx-prd.synchronoss.net ([10.2.54.6])
 ...
 <20201021194727.BKPM18340.re-prd-fep-041.btinternet.com@re-prd-rgout-003.btmx-prd.synchronoss.net>;
 Wed, 21 Oct 2020 20:47:27 +0100
Authentication-Results: btinternet.com; none
X-SNCR-Rigid: 5ED9C2FD16E8D9EB
X-Originating-IP: [86.139.158.27]
X-OWM-Source-IP: 86.139.158.27 (GB)
X-OWM-Env-Sender: jonturney@btinternet.com
X-VadeSecure-score: verdict=clean score=0/300, class=clean
X-RazorGate-Vade: 
...
Received: from localhost.localdomain (86.139.158.27) by
 ...
 id 5ED9C2FD16E8D9EB; Wed, 21 Oct 2020 20:47:27 +0100
From: Jon Turney <jon.turney@dronecode.org.uk>
To: cygwin-patches@cygwin.com
Cc: Jon Turney <jon.turney@dronecode.org.uk>
Subject: [PATCH 3/3] Remove recursive configure for cygwin
Date: Wed, 21 Oct 2020 20:47:05 +0100
Message-Id: <20201021194705.19056-4-jon.turney@dronecode.org.uk>
...
X-Spam-Status: No, score=-1197.7 required=5.0 tests=BAYES_00, FORGED_SPF_HELO,
 GIT_PATCH_0, KAM_ASCII_DIVIDERS, KAM_DMARC_STATUS, KAM_LAZY_DOMAIN_SECURITY,
 KAM_LINEPADDING, RCVD_IN_DNSWL_NONE, RCVD_IN_MSPIKE_H2,
 SCC_10_SHORT_WORD_LINES, SCC_20_SHORT_WORD_LINES, SCC_35_SHORT_WORD_LINES,
 SCC_5_SHORT_WORD_LINES, SPF_HELO_PASS, SPF_NONE,
...
X-List-Received-Date: Wed, 21 Oct 2020 19:48:18 -0000
...
---
 ...
 26 files changed, 89 insertions(+), 24631 deletions(-)
...
index f1c1ce771..598ddf51c 100644
...
-SUBDIRS=@subdirs@
+SUBDIRS=cygwin cygserver doc utils
...
index 5248e2a2a..d34d337e1 100644
...
index 12373891e..0b1d4668d 100755
--- a/winsup/autogen.sh
+++ b/winsup/autogen.sh
@@ -10,8 +10,3 @@ fi
...
index 65369ae7f..cf118bad5 100644
...
index 7b250dd68..c37dc7c8f 100644
...
@@ -66,9 +65,6 @@ cygserver.exe: $(CYGWIN_LIB) $(OBJS)
 $(cygwin_build)/%.o:
 	$(MAKE) -C $(@D) $(@F)
...
index dad526b74..9e986ca83 100644
...
-configure_args=@configure_args@
 ...
 CFLAGS?=@CFLAGS@
 CXXFLAGS?=@CXXFLAGS@
@@ -696,10 +695,6 @@ $(TEST_LIB_NAME): $(LIB_NAME)
...
@@ -776,9 +771,6 @@ version.cc: mkvers.sh include/cygwin/version.h winver.rc $(src_files)
...
index cb46a91cf..cc4a1bec3 100644
...
index add29d10f..2e67c7286 100644
...
-configure_args=@configure_args@
 ...
 CFLAGS:=@CFLAGS@
@@ -49,7 +48,9 @@ CYGWIN_BINS := ${addsuffix .exe,chattr cygpath gencat getconf getfacl ldd locale
