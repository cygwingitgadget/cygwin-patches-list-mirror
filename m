...
Received: from mail231.csoft.net (mail231.csoft.net [66.216.5.135])
	by sourceware.org (Postfix) with ESMTPS id D010C3858D20
	for <cygwin-patches@cygwin.com>; Fri, 21 Mar 2025 23:49:16 +0000 (GMT)
DMARC-Filter: OpenDMARC Filter v1.4.2 sourceware.org D010C3858D20
Authentication-Results: sourceware.org; dmarc=pass (p=reject dis=none) header.from=jdrake.com
Authentication-Results: sourceware.org; spf=pass smtp.mailfrom=jdrake.com
ARC-Filter: OpenARC Filter v1.0.0 sourceware.org D010C3858D20
Authentication-Results: server2.sourceware.org; arc=none smtp.remote-ip=66.216.5.135
ARC-Seal: i=1; a=rsa-sha256; d=sourceware.org; s=key; t=1742600956; cv=none;
	b=elmctfk8PSPizk3k1ZgHpbVr6h1+WIO1M6oxZBswPq1pZlHcShu1InYJg/yLw0aW/ehL1FfGApxfLPhsX0VxfPFey+yGu7oYubZZB4LDKRUjFKjPsLwmAFsCXRSyLPcxKAEf6a6SvFr9iQpuA7gqghkgmMhkKfSpfCqqne0vZ10=
ARC-Message-Signature: i=1; a=rsa-sha256; d=sourceware.org; s=key;
	t=1742600956; c=relaxed/simple;
	bh=+4plZIkjuvy+fO0vGcbnTfpBmvtNQn5v2Pe+vPdEapM=;
	h=DKIM-Signature:Date:From:To:Subject:Message-ID:MIME-Version; b=cSRXJVsEro95fmL4VTwiJYZZn1dEW/nx3DKGXZdRHnr3EeiX/aVz3aAAcjnfjS0e2nEmvXSGKDTcVv82fJrwMj4H/3BXSxq4inz1KzxL6q8yq+AX9XOlIrn4dPRAH95bqo2oyCxRbC7BI7RTlMvXLJfsAyDauA5z9AQ3SMTEPTc=
ARC-Authentication-Results: i=1; server2.sourceware.org
DKIM-Filter: OpenDKIM Filter v2.11.0 sourceware.org D010C3858D20
Authentication-Results: sourceware.org;
	dkim=pass (1024-bit key, unprotected) header.d=jdrake.com header.i=@jdrake.com header.a=rsa-sha1 header.s=csoft header.b=vGoIataB
Received: from mail231.csoft.net (localhost [127.0.0.1])
	by mail231.csoft.net (Postfix) with ESMTP id 833E345CAB
	for <cygwin-patches@cygwin.com>; Fri, 21 Mar 2025 19:49:16 -0400 (EDT)
DKIM-Signature: v=1; a=rsa-sha1; c=relaxed; d=jdrake.com; h=date:from:to
	:subject:message-id:mime-version:content-type; s=csoft; bh=gpRSJ
	oYtJ+eWEtYA6Ea0gxsZrrQ=; b=vGoIataB83nkWVdDcmL9fmAe+SoM3ibzYvb5q
	9Cey7QR46UMALGFraZ7dy9+G10d6RJjpzLnleLCSCYTDu32TfWnul50OqJYoR0Uq
	ISUDHtHESSpUFaA2Evg0JK+dnJNSVDgyVww86Dz185UKEbrV7CC14VlQ4K+ru9z0
	218EvA=
Received: from mail231 (mail231 [66.216.5.135])
	...
	by mail231.csoft.net (Postfix) with ESMTPSA id 6A01545CA9
	for <cygwin-patches@cygwin.com>; Fri, 21 Mar 2025 19:49:16 -0400 (EDT)
Date: Fri, 21 Mar 2025 16:49:16 -0700 (PDT)
From: Jeremy Drake <cygwin@jdrake.com>
X-X-Sender: jeremyd@resin.csoft.net
To: cygwin-patches@cygwin.com
Subject: [PATCH 3/4] Cygwin: use udis86 to find fast cwd pointer on x64
Message-ID: <a6f2da0e-0562-438c-2378-a8d7a760644b@jdrake.com>
MIME-Version: 1.0
