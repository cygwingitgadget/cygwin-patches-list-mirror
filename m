Return-Path: <cygwin-patches-return-3776-listarch-cygwin-patches=sources.redhat.com@cygwin.com>
Received: (qmail 6853 invoked by alias); 2 Apr 2003 13:16:57 -0000
...
Received: (qmail 6844 invoked from network); 2 Apr 2003 13:16:56 -0000
Date: Wed, 02 Apr 2003 13:16:00 -0000
From: Jason Tishler <jason@tishler.net>
Subject: cygwin_internal(CW_CHECK_NTSEC, filename) patch
To: Cygwin-Patches <cygwin-patches@cygwin.com>
Mail-followup-to: Cygwin-Patches <cygwin-patches@cygwin.com>
Message-id: <20030402131626.GA1888@tishler.net>
MIME-version: 1.0
Content-type: multipart/mixed; boundary="Boundary_(ID_+1Z7wck9D+uDSnBDvWsv7w)"
User-Agent: Mutt/1.4i
X-SW-Source: 2003-q2/txt/msg00003.txt.bz2


--Boundary_(ID_+1Z7wck9D+uDSnBDvWsv7w)
...
--Boundary_(ID_+1Z7wck9D+uDSnBDvWsv7w)
Content-type: text/plain; charset=us-ascii; NAME=check_ntsec.patch
Content-transfer-encoding: 7BIT
Content-disposition: attachment; filename=check_ntsec.patch
Content-length: 5303
...
--Boundary_(ID_+1Z7wck9D+uDSnBDvWsv7w)
Content-type: text/plain; charset=us-ascii; NAME=check_ntsec.ChangeLog
Content-transfer-encoding: 7BIT
Content-disposition: attachment; filename=check_ntsec.ChangeLog
Content-length: 526
...
--Boundary_(ID_+1Z7wck9D+uDSnBDvWsv7w)
Content-type: text/plain; charset=us-ascii; NAME=check_ntsec.cc
Content-transfer-encoding: 7BIT
Content-disposition: attachment; filename=check_ntsec.cc
Content-length: 250
