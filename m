...
Received: from dmta0017.nifty.com (mta-snd00012.nifty.com [106.153.226.44])
	by sourceware.org (Postfix) with ESMTPS id 37CB1385840C
	for <cygwin-patches@cygwin.com>; Mon, 28 Aug 2023 12:20:24 +0000 (GMT)
DMARC-Filter: OpenDMARC Filter v1.4.2 sourceware.org 37CB1385840C
Authentication-Results: sourceware.org; dmarc=fail (p=none dis=none) header.from=nifty.ne.jp
Authentication-Results: sourceware.org; spf=fail smtp.mailfrom=nifty.ne.jp
Received: from HP-Z230 by dmta0017.nifty.com with ESMTP
          id <20230828122022446.NIHR.104452.HP-Z230@nifty.com>
          for <cygwin-patches@cygwin.com>; Mon, 28 Aug 2023 21:20:22 +0900
Date: Mon, 28 Aug 2023 21:20:22 +0900
From: Takashi Yano <takashi.yano@nifty.ne.jp>
To: cygwin-patches@cygwin.com
Subject: Re: [PATCH v2] Cygwin: spawn: Fix segfalt when too many command
 line args are specified.
Message-Id: <20230828212022.a3bde9e4573962530533a0e2@nifty.ne.jp>
In-Reply-To: <20230828210953.5b5c11840014f916b6ea21b3@nifty.ne.jp>
References: <20230828094605.2405-1-takashi.yano@nifty.ne.jp>
	<ZOx9j/YRr3UX88wV@calimero.vinschen.de>
	<20230828210953.5b5c11840014f916b6ea21b3@nifty.ne.jp>
X-Mailer: Sylpheed 3.7.0 (GTK+ 2.24.30; i686-pc-mingw32)
Mime-Version: 1.0
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: 7bit
X-Spam-Status: No, score=-12.6 required=5.0 tests=BAYES_00,GIT_PATCH_0,KAM_DMARC_STATUS,NICE_REPLY_A,RCVD_IN_DNSWL_NONE,SPF_HELO_PASS,SPF_PASS,TXREP autolearn=ham autolearn_force=no version=3.4.6
