Return-Path: <cygwin-patches-return-7732-listarch-cygwin-patches=sources.redhat.com@cygwin.com>
Received: (qmail 9873 invoked by alias); 18 Oct 2012 17:20:32 -0000
Received: (qmail 9452 invoked by uid 22791); 18 Oct 2012 17:20:30 -0000
...
Received: from mail-ie0-f171.google.com (HELO mail-ie0-f171.google.com) (209.85.223.171)    by sourceware.org (qpsmtpd/0.43rc1) with ESMTP; Thu, 18 Oct 2012 17:20:23 +0000
Received: by mail-ie0-f171.google.com with SMTP id s9so15055375iec.2        for <cygwin-patches@cygwin.com>; Thu, 18 Oct 2012 10:20:23 -0700 (PDT)
Received: by 10.50.40.137 with SMTP id x9mr5906220igk.1.1350580822859;        Thu, 18 Oct 2012 10:20:22 -0700 (PDT)
Received: from [192.168.0.100] (S0106000cf16f58b1.wp.shawcable.net. [24.79.200.150])        by mx.google.com with ESMTPS id uj11sm13789678igb.15.2012.10.18.10.20.21        (version=TLSv1/SSLv3 cipher=OTHER);        Thu, 18 Oct 2012 10:20:22 -0700 (PDT)
Message-ID: <1350580828.3492.73.camel@YAAKOV04>
Subject: Re: [patch]: Decouple cygwin building from in-tree mingw/w32api building
From: "Yaakov (Cygwin/X)" <yselkowitz@users.sourceforge.net>
To: cygwin-patches <cygwin-patches@cygwin.com>
Date: Thu, 18 Oct 2012 17:20:00 -0000
In-Reply-To: <20121018083419.GC6221@calimero.vinschen.de>
References: <CAEwic4ZBrjVPDV1Y3tc6r7baGzxNbrjgj1MUgse6zYSMHiCUhQ@mail.gmail.com>	 <20121017164440.GA12989@ednor.casa.cgf.cx>	 <20121017170514.GD10578@calimero.vinschen.de>	 <20121017193258.GA15271@ednor.casa.cgf.cx>	 <1350545597.3492.59.camel@YAAKOV04>	 <20121018083419.GC6221@calimero.vinschen.de>
Content-Type: multipart/mixed; boundary="=-kwe2+mA/C4JvqDJuQu1v"
Mime-Version: 1.0
...
X-SW-Source: 2012-q4/txt/msg00009.txt.bz2


--=-kwe2+mA/C4JvqDJuQu1v
...
+++ configure	18 Oct 2012 17:13:48 -0000
...
+++ configure.ac	18 Oct 2012 17:13:49 -0000
...
+++ winsup/Makefile.common	18 Oct 2012 17:13:54 -0000
...
@@ -134,7 +116,7 @@ COMPILE_CXX=$(CXX) $c $(if $($(*F)_STDIN
...
+++ winsup/Makefile.in	18 Oct 2012 17:13:54 -0000
...
+++ winsup/configure.in	18 Oct 2012 17:13:54 -0000
@@ -45,7 +45,10 @@ esac
...
+++ winsup/cygwin/Makefile.in	18 Oct 2012 17:13:54 -0000
...
+++ winsup/utils/Makefile.in	18 Oct 2012 17:13:54 -0000
...
+++ winsup/utils/cygcheck.cc	18 Oct 2012 17:13:55 -0000
@@ -22,11 +22,10 @@
 #include "path.h"
 #include "wide_path.h"
 #include <getopt.h>
...
+++ winsup/utils/path.cc	18 Oct 2012 17:13:55 -0000
@@ -23,9 +23,9 @@ details. */
 #include <malloc.h>
 #include <wchar.h>
 #include "path.h"
...
+++ winsup/utils/strace.cc	18 Oct 2012 17:13:55 -0000
@@ -27,9 +27,9 @@ details. */
 #include <time.h>
 #include <signal.h>
 #include <errno.h>
