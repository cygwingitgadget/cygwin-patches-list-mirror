...
Received: from nihsmtpxway6.hub.nih.gov (nihsmtpxway6.hub.nih.gov
 [128.231.90.122])
 by sourceware.org (Postfix) with ESMTPS id 660243858D3C
 for <cygwin-patches@cygwin.com>; Mon, 17 Jan 2022 18:03:39 +0000 (GMT)
DMARC-Filter: OpenDMARC Filter v1.4.1 sourceware.org 660243858D3C
X-SBRS-Extended: Low
X-IronPortListener: non-ces-out
X-IronPortListener: non-ces-out
X-IronPort-AV: E=Sophos;i="5.88,296,1635220800"; d="scan'208";a="96427565"
...
Received: from mail2.ncbi.nlm.nih.gov (vhod11.be-md.ncbi.nlm.nih.gov
 [130.14.26.81])
 by mail1.ncbi.nlm.nih.gov (Postfix) with ESMTP id 0D4A7340004;
 Mon, 17 Jan 2022 13:03:36 -0500 (EST)
From: Anton Lavrentiev <lavr@ncbi.nlm.nih.gov>
To: cygwin-patches@cygwin.com
Subject: [PATCH 4/5] Cygwin: resolver: A little more consitency in debug
 messages
Date: Mon, 17 Jan 2022 13:03:13 -0500
Message-Id: <20220117180314.29064-5-lavr@ncbi.nlm.nih.gov>
