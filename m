...
Received: from mail231.csoft.net (mail231.csoft.net [66.216.5.135])
	by sourceware.org (Postfix) with ESMTPS id B6F243857C58
	for <cygwin-patches@cygwin.com>; Fri, 21 Mar 2025 23:45:24 +0000 (GMT)
DMARC-Filter: OpenDMARC Filter v1.4.2 sourceware.org B6F243857C58
Authentication-Results: sourceware.org; dmarc=pass (p=reject dis=none) header.from=jdrake.com
Authentication-Results: sourceware.org; spf=pass smtp.mailfrom=jdrake.com
ARC-Filter: OpenARC Filter v1.0.0 sourceware.org B6F243857C58
Authentication-Results: server2.sourceware.org; arc=none smtp.remote-ip=66.216.5.135
ARC-Seal: i=1; a=rsa-sha256; d=sourceware.org; s=key; t=1742600724; cv=none;
	b=rpTSzjk6Tmd79Bcf+zxl3QsM5CanqhPib6vsBcG9guzT1+8FS6ZqNUDGpcFaUwbhnsyBuwtgaU6Exaix/PdRxIynAIrmt9FsXZ8wy4go5NucYEhf73evy3fJ4tgdwA/OdasbauMBKrWFwgct21GWr1vrUlgOHnmMXYKftfT2H7k=
ARC-Message-Signature: i=1; a=rsa-sha256; d=sourceware.org; s=key;
	t=1742600724; c=relaxed/simple;
	bh=PHfxNT/8X1FiTCtOirZNdtuEhwfdXvzVVDgKGRXVGc4=;
	h=DKIM-Signature:Date:From:To:Subject:Message-ID:MIME-Version; b=ZXRCjsu+LwtfNP56V4pXH9fKqSVRTeTkpzetxeTyQDwTa91a5duHWLWClSgdODxq/WXb9o/LzSt0E37440nkLasJYHxsxFwC5CgzYFqxOjBaFn5E0Oszao3osNH+VbMen3gOXYEh1x+ZouobFORGpeRbi0xBfWL0hqdqaLMooCM=
ARC-Authentication-Results: i=1; server2.sourceware.org
DKIM-Filter: OpenDKIM Filter v2.11.0 sourceware.org B6F243857C58
Authentication-Results: sourceware.org;
	dkim=pass (1024-bit key, unprotected) header.d=jdrake.com header.i=@jdrake.com header.a=rsa-sha1 header.s=csoft header.b=RZvzu5CF
Received: from mail231.csoft.net (localhost [127.0.0.1])
	by mail231.csoft.net (Postfix) with ESMTP id 644AD45CAB
	for <cygwin-patches@cygwin.com>; Fri, 21 Mar 2025 19:45:24 -0400 (EDT)
DKIM-Signature: v=1; a=rsa-sha1; c=relaxed; d=jdrake.com; h=date:from:to
	:subject:message-id:mime-version:content-type; s=csoft; bh=I62vO
	O3tBKHhYN59dIW8EOlvnGg=; b=RZvzu5CFuP6N+1cZYsUFIutvsvThi1TsDLLWE
	Tvu8cnhMHeu2IAsVPZeNg+ykyCrzwQlMuTg3PLqOnEqdTIgMCyIgh8EF2DXzP2r8
	sndle1rR2eR6vE7Ldsxin+fwtv5qWX3CJWqAcsEeapiutseBjQu7qXjTv8aecg7q
	i+Gxaw=
Received: from mail231 (mail231 [66.216.5.135])
	...
	by mail231.csoft.net (Postfix) with ESMTPSA id 5E83845CA9
	for <cygwin-patches@cygwin.com>; Fri, 21 Mar 2025 19:45:24 -0400 (EDT)
Date: Fri, 21 Mar 2025 16:45:24 -0700 (PDT)
From: Jeremy Drake <cygwin@jdrake.com>
X-X-Sender: jeremyd@resin.csoft.net
To: cygwin-patches@cygwin.com
Subject: [PATCH 1/4] Cygwin: factor out find_fast_cwd_pointer to arch-specific
 file
Message-ID: <40090bb4-a705-4ea0-59ed-a0c4201863e2@jdrake.com>
MIME-Version: 1.0
