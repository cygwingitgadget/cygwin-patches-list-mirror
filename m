Return-Path: <cygwin-patches-return-1902-listarch-cygwin-patches=sourceware.cygnus.com@cygwin.com>
Received: (qmail 9928 invoked by alias); 25 Feb 2002 21:05:08 -0000
...
Received: (qmail 9869 invoked from network); 25 Feb 2002 21:05:06 -0000
Message-ID: <001301c1be40$647220b0$0100a8c0@advent02>
From: "Chris January" <chris@atomice.net>
To: <cygwin-patches@cygwin.com>
References: <008901c1b1be$80b36e70$0100a8c0@advent02> <20020210043745.GA5128@redhat.com> <006401c1b998$c106f230$0100a8c0@advent02> <20020219230649.GC4626@redhat.com> <024601c1b9a3$2f8fb700$0100a8c0@advent02> <20020220003104.GD22591@redhat.com> <20020225164230.GA17325@redhat.com>
Subject: Re: /proc and /proc/registry
Date: Mon, 25 Feb 2002 13:46:00 -0000
MIME-Version: 1.0
Content-Type: multipart/mixed;
	boundary="----=_NextPart_000_0010_01C1BE40.63979F30"
X-Priority: 3
X-MSMail-Priority: Normal
X-Mailer: Microsoft Outlook Express 6.00.2600.0000
X-MimeOLE: Produced By Microsoft MimeOLE V6.00.2600.0000
X-SW-Source: 2002-q1/txt/msg00259.txt.bz2

This is a multi-part message in MIME format.

------=_NextPart_000_0010_01C1BE40.63979F30
...
diff -NaurbB cygwin.bak/Makefile.in cygwin/Makefile.in=0A=
--- cygwin.bak/Makefile.in	Mon Feb 25 18:15:36 2002=0A=
+++ cygwin/Makefile.in	Mon Feb 25 18:37:05 2002=0A=
@@ -122,16 +122,18 @@=0A=
...
diff -NaurbB cygwin.bak/dtable.cc cygwin/dtable.cc=0A=
--- cygwin.bak/dtable.cc	Mon Feb 25 18:15:35 2002=0A=
+++ cygwin/dtable.cc	Mon Feb 25 18:33:37 2002=0A=
@@ -363,6 +363,15 @@=0A=
       case FH_OSS_DSP:=0A=
...
+        break;=0A=
 	...
 	fh =3D NULL;=0A=
diff -NaurbB cygwin.bak/fhandler.h cygwin/fhandler.h=0A=
--- cygwin.bak/fhandler.h	Mon Feb 25 18:15:36 2002=0A=
+++ cygwin/fhandler.h	Mon Feb 25 18:33:37 2002=0A=
@@ -70,8 +70,11 @@=0A=
...
diff -NaurbB cygwin.bak/fhandler_proc.cc cygwin/fhandler_proc.cc=0A=
--- cygwin.bak/fhandler_proc.cc	Thu Jan  1 00:00:00 1970=0A=
+++ cygwin/fhandler_proc.cc	Mon Feb 25 18:33:37 2002=0A=
@@ -0,0 +1,291 @@=0A=
+/* fhandler_proc.cc */=0A=
+/*=0A=
...
+  return res;=0A=
+}=0A=
diff -NaurbB cygwin.bak/fhandler_process.cc cygwin/fhandler_process.cc=0A=
--- cygwin.bak/fhandler_process.cc	Thu Jan  1 00:00:00 1970=0A=
+++ cygwin/fhandler_process.cc	Mon Feb 25 18:33:37 2002=0A=
@@ -0,0 +1,287 @@=0A=
...
+  return res;=0A=
+}=0A=
diff -NaurbB cygwin.bak/fhandler_registry.cc cygwin/fhandler_registry.cc=0A=
--- cygwin.bak/fhandler_registry.cc	Thu Jan  1 00:00:00 1970=0A=
+++ cygwin/fhandler_registry.cc	Mon Feb 25 18:33:37 2002=0A=
@@ -0,0 +1,502 @@=0A=
...
+  return hKey;=0A=
+}=0A=
diff -NaurbB cygwin.bak/fhandler_virtual.cc cygwin/fhandler_virtual.cc=0A=
--- cygwin.bak/fhandler_virtual.cc	Thu Jan  1 00:00:00 1970=0A=
+++ cygwin/fhandler_virtual.cc	Mon Feb 25 18:33:37 2002=0A=
@@ -0,0 +1,238 @@=0A=
...
+  return 0;=0A=
+}=0A=
diff -NaurbB cygwin.bak/path.cc cygwin/path.cc=0A=
--- cygwin.bak/path.cc	Mon Feb 25 18:15:37 2002=0A=
+++ cygwin/path.cc	Mon Feb 25 18:33:37 2002=0A=
@@ -118,6 +118,12 @@=0A=
...
+  if (!isvirtual_dev(devn))=0A=
     ...
     {=0A=
diff -NaurbB cygwin.bak/path.h cygwin/path.h=0A=
--- cygwin.bak/path.h	Mon Feb 25 18:15:37 2002=0A=
+++ cygwin/path.h	Mon Feb 25 18:33:37 2002=0A=
@@ -178,3 +178,6 @@=0A=
=20=0A=
