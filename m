...
Received: from conuserg-08.nifty.com (conuserg-08.nifty.com [210.131.2.75])
 by sourceware.org (Postfix) with ESMTPS id E38B83857C68
 for <cygwin-patches@cygwin.com>; Mon, 25 Jan 2021 09:41:16 +0000 (GMT)
DMARC-Filter: OpenDMARC Filter v1.3.2 sourceware.org E38B83857C68
Received: from localhost.localdomain (x067108.dynamic.ppp.asahi-net.or.jp
 [122.249.67.108]) (authenticated)
 by conuserg-08.nifty.com with ESMTP id 10P9e6xV020289;
 Mon, 25 Jan 2021 18:40:49 +0900
DKIM-Filter: OpenDKIM Filter v2.10.3 conuserg-08.nifty.com 10P9e6xV020289
X-Nifty-SrcIP: [122.249.67.108]
From: Takashi Yano <takashi.yano@nifty.ne.jp>
To: cygwin-patches@cygwin.com
Subject: [PATCH v3 2/4] Cygwin: pty: Keep code page between non-cygwin apps.
Date: Mon, 25 Jan 2021 18:39:48 +0900
Message-Id: <20210125093950.1386-3-takashi.yano@nifty.ne.jp>
X-Mailer: git-send-email 2.30.0
In-Reply-To: <20210125093950.1386-1-takashi.yano@nifty.ne.jp>
References: <20210125093950.1386-1-takashi.yano@nifty.ne.jp>
MIME-Version: 1.0
...
X-Spam-Status: No, score=-8.8 required=5.0 tests=BAYES_00, DKIM_SIGNED,
 ...
 URIBL_SBL_A autolearn=ham autolearn_force=no version=3.4.2
...
X-List-Received-Date: Mon, 25 Jan 2021 09:41:18 -0000
