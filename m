Return-Path: <cygwin-patches-return-9144-listarch-cygwin-patches=sources.redhat.com@cygwin.com>
Received: (qmail 64429 invoked by alias); 24 Jul 2018 05:32:37 -0000
...
Received: (qmail 63355 invoked by uid 89); 24 Jul 2018 05:32:36 -0000
Authentication-Results: sourceware.org; auth=none
X-Spam-SWARE-Status: No, score=-23.7 required=5.0 tests=AWL,BAYES_00,GIT_PATCH_0,GIT_PATCH_1,GIT_PATCH_2,GIT_PATCH_3,KAM_LAZY_DOMAIN_SECURITY autolearn=ham version=3.3.2 spammy=stays, flock, rights
...
Received: (from daemon@localhost)	by m0.truegem.net (8.12.11/8.12.11) id w6O5WXUV095203;	Mon, 23 Jul 2018 22:32:33 -0700 (PDT)	(envelope-from mark@maxrnd.com)
Received: from 76-217-5-154.lightspeed.irvnca.sbcglobal.net(76.217.5.154), claiming to be "localhost.localdomain" via SMTP by m0.truegem.net, id smtpdCIbj8Y; Mon Jul 23 22:32:25 2018
From: Mark Geisert <mark@maxrnd.com>
To: cygwin-patches@cygwin.com
Cc: Mark Geisert <mark@maxrnd.com>
Subject: [PATCH final 2/3] POSIX Asynchronous I/O support: fhandler files
Date: Tue, 24 Jul 2018 05:32:00 -0000
Message-Id: <20180724053159.2676-3-mark@maxrnd.com>
In-Reply-To: <20180724053159.2676-1-mark@maxrnd.com>
References: <20180724053159.2676-1-mark@maxrnd.com>
X-IsSubscribed: yes
X-SW-Source: 2018-q3/txt/msg00039.txt.bz2
