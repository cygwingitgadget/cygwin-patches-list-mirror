...
Received: from dmta1018.nifty.com (mta-snd01005.nifty.com [106.153.227.37])
	by sourceware.org (Postfix) with ESMTPS id 4FD513858D35
	for <cygwin-patches@cygwin.com>; Mon, 28 Aug 2023 12:27:12 +0000 (GMT)
DMARC-Filter: OpenDMARC Filter v1.4.2 sourceware.org 4FD513858D35
Authentication-Results: sourceware.org; dmarc=fail (p=none dis=none) header.from=nifty.ne.jp
Authentication-Results: sourceware.org; spf=fail smtp.mailfrom=nifty.ne.jp
Received: from HP-Z230 by dmta1018.nifty.com with ESMTP
          id <20230828122710066.YBPN.25681.HP-Z230@nifty.com>
          for <cygwin-patches@cygwin.com>; Mon, 28 Aug 2023 21:27:10 +0900
Date: Mon, 28 Aug 2023 21:27:09 +0900
From: Takashi Yano <takashi.yano@nifty.ne.jp>
To: cygwin-patches@cygwin.com
Subject: Re: [PATCH v2] Cygwin: spawn: Fix segfalt when too many command
 line args are specified.
Message-Id: <20230828212709.0d1f2703dbc10c8ae96da3ac@nifty.ne.jp>
