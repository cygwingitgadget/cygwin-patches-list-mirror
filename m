...
Received: from mout.gmx.net (mout.gmx.net [212.227.15.18])
 by sourceware.org (Postfix) with ESMTPS id 31090385BF98
 for <cygwin-patches@cygwin.com>; Mon, 21 Feb 2022 13:36:47 +0000 (GMT)
DMARC-Filter: OpenDMARC Filter v1.4.1 sourceware.org 31090385BF98
Authentication-Results: sourceware.org;
 dmarc=pass (p=none dis=none) header.from=gmx.de
Authentication-Results: sourceware.org; spf=pass smtp.mailfrom=gmx.de
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=gmx.net;
 s=badeba3b8450; t=1645450606;
 bh=EmG/i/tfQoy5MrZ33BJjz1vioKrNV7MS8GvO9owFpzM=;
 h=X-UI-Sender-Class:Date:From:To:Subject:In-Reply-To:References;
 b=doXD1gV/9VGSojP7qPdCdewt1SkXxC3uP9PDz0lqLkICDHQg4TFuDjfnBCtcwBDLg
 22mXJGbPS84TjgP99LHOi8sS1S+/+6q6BnpfvRO6Mr6tQB51rrBEMsSe3Kr6tty1bF
 Xc8u0wK/RiHYIY6u12bEKTSEM21JQucDmDIoQ72Y=
X-UI-Sender-Class: 01bb95c1-4bf8-414a-932a-4f6e2808ef9c
Received: from [172.28.129.168] ([89.1.212.236]) by mail.gmx.net (mrgmx004
 [212.227.17.190]) with ESMTPSA (Nemesis) id 1N5VDE-1oIwoZ1xXO-016v70 for
 <cygwin-patches@cygwin.com>; Mon, 21 Feb 2022 14:36:45 +0100
Date: Mon, 21 Feb 2022 14:36:44 +0100 (CET)
From: Johannes Schindelin <johannes.schindelin@gmx.de>
X-X-Sender: virtualbox@gitforwindows.org
To: cygwin-patches@cygwin.com
Subject: [PATCH 2/2] Regenerate devices.cc
In-Reply-To: <cover.1645450518.git.johannes.schindelin@gmx.de>
Message-ID: <15a4784f8008ca1b89b7b995cf18734932e90177.1645450518.git.johannes.schindelin@gmx.de>
References: <cover.1645450518.git.johannes.schindelin@gmx.de>
User-Agent: Alpine 2.21.1 (DEB 209 2017-03-23)
MIME-Version: 1.0
Content-Type: text/plain; charset=US-ASCII
X-Provags-ID: V03:K1:5xaWEz9fE6mmfoKzBOsSyNvhHEIULPaOwrWpNQ/cksFx34NHmdI
 c3Ah5JyUisfbQgVtLfQCyYOp95/woRjz5V1Kx8TTgKLZe+BwxGUY29SgoKgZ3mtYs8dkk4F
 ql0ogcdNdoLD4PnOclN6+ykVUGC5PQpz25TJaB8LtOQzm0+qcoHeG0yvCtLnAVtubQtSygV
 JfY2H5ogTxq1XpuH84Vkw==
X-UI-Out-Filterresults: notjunk:1;V03:K0:OrS4viechDk=:3rdkmz6ZEiZRpoFAgC6ArC
 
 ku27L7tuZF4OAlMIFQRBw9ejJGTA1IuAB0q
...
X-List-Received-Date: Mon, 21 Feb 2022 13:36:53 -0000
...
=2D-- a/winsup/cygwin/devices.cc
+++ b/winsup/cygwin/devices.cc
@@ -300,6 +300,7 @@ const _RDATA _device dev_storage[] =3D
   {"/dev/cons127", BRACK(FHDEV(DEV_CONS_MAJOR, 127)), "/dev/cons127", exi=
sts_console, S_IFCHR, true},
   {"/dev/console", BRACK(FH_CONSOLE), "/dev/console", exists_console, S_I=
FCHR, true},
   {"/dev/dsp", BRACK(FH_OSS_DSP), "\\Device\\Null", exists_ntdev, S_IFCHR=
, true},
+  {"/dev/fd", BRACK(FH_DEV_FD), "/proc/self/fd", exists, S_IFLNK, true},
   {"/dev/fd0", BRACK(FHDEV(DEV_FLOPPY_MAJOR, 0)), "\\Device\\Floppy0", ex=
ists_ntdev, S_IFBLK, true},
   {"/dev/fd1", BRACK(FHDEV(DEV_FLOPPY_MAJOR, 1)), "\\Device\\Floppy1", ex=
ists_ntdev, S_IFBLK, true},
   {"/dev/fd2", BRACK(FHDEV(DEV_FLOPPY_MAJOR, 2)), "\\Device\\Floppy2", ex=
ists_ntdev, S_IFBLK, true},
@@ -736,6 +737,9 @@ const _RDATA _device dev_storage[] =3D
...
exists_ntdev, S_IFBLK, true},
+  {"/dev/stderr", BRACK(FH_DEV_FD), "/proc/self/fd/2", exists, S_IFLNK, t=
rue},
+  {"/dev/stdin", BRACK(FH_DEV_FD), "/proc/self/fd/0", exists, S_IFLNK, tr=
ue},
+  {"/dev/stdout", BRACK(FH_DEV_FD), "/proc/self/fd/1", exists, S_IFLNK, t=
rue},
   {"/dev/tty", BRACK(FH_TTY), "/dev/tty", exists, S_IFCHR, true},
   {"/dev/ttyS0", BRACK(FHDEV(DEV_SERIAL_MAJOR, 0)), "\\??\\COM1", exists_=
ntdev, S_IFCHR, true},
   {"/dev/ttyS1", BRACK(FHDEV(DEV_SERIAL_MAJOR, 1)), "\\??\\COM2", exists_=
ntdev, S_IFCHR, true},
@@ -1002,9 +1006,9 @@ const _RDATA _device dev_storage[] =3D

 const _device *cons_dev =3D dev_storage + 20;
 const _device *console_dev =3D dev_storage + 148;
-const _device *ptym_dev =3D dev_storage + 720;
-const _device *ptys_dev =3D dev_storage + 297;
-const _device *urandom_dev =3D dev_storage + 715;
+const _device *ptym_dev =3D dev_storage + 724;
+const _device *ptys_dev =3D dev_storage + 298;
+const _device *urandom_dev =3D dev_storage + 719;


 static KR_device_t KR_find_keyword (const char *KR_keyword, int KR_length=
)
@@ -1034,7 +1038,7 @@ return	NULL;
           if (strncmp (KR_keyword, ":pipe", 5) =3D=3D 0)
             {
 {
...
@@ -1049,7 +1053,7 @@ return	NULL;
           if (strncmp (KR_keyword, ":fifo", 5) =3D=3D 0)
             {
 {
...
@@ -1073,7 +1077,7 @@ return	NULL;
           if (strncmp (KR_keyword, ":ptym9", 6) =3D=3D 0)
             {
 {
...
@@ -1088,7 +1092,7 @@ return	NULL;
           if (strncmp (KR_keyword, ":ptym8", 6) =3D=3D 0)
             {
 {
...
@@ -1103,7 +1107,7 @@ return	NULL;
           if (strncmp (KR_keyword, ":ptym7", 6) =3D=3D 0)
             {
 {
...
@@ -1118,7 +1122,7 @@ return	NULL;
           if (strncmp (KR_keyword, ":ptym6", 6) =3D=3D 0)
             {
 {
...
@@ -1133,7 +1137,7 @@ return	NULL;
           if (strncmp (KR_keyword, ":ptym5", 6) =3D=3D 0)
             {
 {
...
@@ -1148,7 +1152,7 @@ return	NULL;
           if (strncmp (KR_keyword, ":ptym4", 6) =3D=3D 0)
             {
 {
...
@@ -1163,7 +1167,7 @@ return	NULL;
           if (strncmp (KR_keyword, ":ptym3", 6) =3D=3D 0)
             {
 {
-return dev_storage + 723;
+return dev_storage + 727;
...
@@ -1178,7 +1182,7 @@ return	NULL;
           if (strncmp (KR_keyword, ":ptym2", 6) =3D=3D 0)
             {
 {
-return dev_storage + 722;
+return dev_storage + 726;
...
@@ -1193,7 +1197,7 @@ return	NULL;
           if (strncmp (KR_keyword, ":ptym1", 6) =3D=3D 0)
             {
 {
...
@@ -1208,7 +1212,7 @@ return	NULL;
           if (strncmp (KR_keyword, ":ptym0", 6) =3D=3D 0)
             {
 {
...
@@ -1228,6 +1232,21 @@ return	NULL;
     case 7:
       switch (KR_keyword [5])
         {
+        case 'f':
+          if (strncmp (KR_keyword, "/dev/fd", 7) =3D=3D 0)
+            {
+{
...
@@ -1235,7 +1254,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym99", 7) =3D=3D 0)
                 {
 {
...
@@ -1250,7 +1269,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym98", 7) =3D=3D 0)
                 {
 {
...
@@ -1265,7 +1284,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym97", 7) =3D=3D 0)
                 {
 {
...
@@ -1280,7 +1299,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym96", 7) =3D=3D 0)
                 {
 {
...
@@ -1295,7 +1314,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym95", 7) =3D=3D 0)
                 {
 {
...
@@ -1310,7 +1329,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym94", 7) =3D=3D 0)
                 {
 {
...
@@ -1325,7 +1344,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym93", 7) =3D=3D 0)
                 {
 {
...
@@ -1340,7 +1359,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym92", 7) =3D=3D 0)
                 {
 {
...
@@ -1355,7 +1374,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym91", 7) =3D=3D 0)
                 {
 {
...
@@ -1370,7 +1389,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym90", 7) =3D=3D 0)
                 {
 {
...
@@ -1394,7 +1413,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym89", 7) =3D=3D 0)
                 {
 {
...
@@ -1409,7 +1428,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym88", 7) =3D=3D 0)
                 {
 {
...
@@ -1424,7 +1443,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym87", 7) =3D=3D 0)
                 {
 {
...
@@ -1439,7 +1458,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym86", 7) =3D=3D 0)
                 {
 {
...
@@ -1454,7 +1473,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym85", 7) =3D=3D 0)
                 {
 {
...
@@ -1469,7 +1488,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym84", 7) =3D=3D 0)
                 {
 {
...
@@ -1484,7 +1503,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym83", 7) =3D=3D 0)
                 {
 {
...
@@ -1499,7 +1518,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym82", 7) =3D=3D 0)
                 {
 {
...
@@ -1514,7 +1533,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym81", 7) =3D=3D 0)
                 {
 {
...
@@ -1529,7 +1548,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym80", 7) =3D=3D 0)
                 {
 {
...
@@ -1553,7 +1572,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym79", 7) =3D=3D 0)
                 {
 {
...
@@ -1568,7 +1587,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym78", 7) =3D=3D 0)
                 {
 {
...
@@ -1583,7 +1602,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym77", 7) =3D=3D 0)
                 {
 {
...
@@ -1598,7 +1617,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym76", 7) =3D=3D 0)
                 {
 {
...
@@ -1613,7 +1632,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym75", 7) =3D=3D 0)
                 {
 {
...
@@ -1628,7 +1647,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym74", 7) =3D=3D 0)
                 {
 {
...
@@ -1643,7 +1662,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym73", 7) =3D=3D 0)
                 {
 {
...
@@ -1658,7 +1677,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym72", 7) =3D=3D 0)
                 {
 {
...
@@ -1673,7 +1692,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym71", 7) =3D=3D 0)
                 {
 {
...
@@ -1688,7 +1707,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym70", 7) =3D=3D 0)
                 {
 {
...
@@ -1712,7 +1731,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym69", 7) =3D=3D 0)
                 {
 {
...
@@ -1727,7 +1746,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym68", 7) =3D=3D 0)
                 {
 {
...
@@ -1742,7 +1761,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym67", 7) =3D=3D 0)
                 {
 {
...
@@ -1757,7 +1776,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym66", 7) =3D=3D 0)
                 {
 {
...
@@ -1772,7 +1791,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym65", 7) =3D=3D 0)
                 {
 {
...
@@ -1787,7 +1806,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym64", 7) =3D=3D 0)
                 {
 {
...
@@ -1802,7 +1821,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym63", 7) =3D=3D 0)
                 {
 {
...
@@ -1817,7 +1836,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym62", 7) =3D=3D 0)
                 {
 {
...
@@ -1832,7 +1851,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym61", 7) =3D=3D 0)
                 {
 {
...
@@ -1847,7 +1866,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym60", 7) =3D=3D 0)
                 {
 {
...
@@ -1871,7 +1890,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym59", 7) =3D=3D 0)
                 {
 {
...
@@ -1886,7 +1905,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym58", 7) =3D=3D 0)
                 {
 {
...
@@ -1901,7 +1920,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym57", 7) =3D=3D 0)
                 {
 {
...
@@ -1916,7 +1935,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym56", 7) =3D=3D 0)
                 {
 {
...
@@ -1931,7 +1950,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym55", 7) =3D=3D 0)
                 {
 {
...
@@ -1946,7 +1965,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym54", 7) =3D=3D 0)
                 {
 {
...
@@ -1961,7 +1980,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym53", 7) =3D=3D 0)
                 {
 {
...
@@ -1976,7 +1995,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym52", 7) =3D=3D 0)
                 {
 {
...
@@ -1991,7 +2010,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym51", 7) =3D=3D 0)
                 {
 {
...
@@ -2006,7 +2025,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym50", 7) =3D=3D 0)
                 {
 {
...
@@ -2030,7 +2049,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym49", 7) =3D=3D 0)
                 {
 {
...
@@ -2045,7 +2064,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym48", 7) =3D=3D 0)
                 {
 {
...
@@ -2060,7 +2079,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym47", 7) =3D=3D 0)
                 {
 {
...
@@ -2075,7 +2094,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym46", 7) =3D=3D 0)
                 {
 {
...
@@ -2090,7 +2109,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym45", 7) =3D=3D 0)
                 {
 {
...
@@ -2105,7 +2124,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym44", 7) =3D=3D 0)
                 {
 {
...
@@ -2120,7 +2139,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym43", 7) =3D=3D 0)
                 {
 {
...
@@ -2135,7 +2154,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym42", 7) =3D=3D 0)
                 {
 {
...
@@ -2150,7 +2169,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym41", 7) =3D=3D 0)
                 {
 {
...
@@ -2165,7 +2184,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym40", 7) =3D=3D 0)
                 {
 {
...
@@ -2189,7 +2208,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym39", 7) =3D=3D 0)
                 {
 {
...
@@ -2204,7 +2223,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym38", 7) =3D=3D 0)
                 {
 {
...
@@ -2219,7 +2238,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym37", 7) =3D=3D 0)
                 {
 {
...
@@ -2234,7 +2253,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym36", 7) =3D=3D 0)
                 {
 {
...
@@ -2249,7 +2268,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym35", 7) =3D=3D 0)
                 {
 {
...
@@ -2264,7 +2283,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym34", 7) =3D=3D 0)
                 {
 {
...
@@ -2279,7 +2298,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym33", 7) =3D=3D 0)
                 {
 {
...
@@ -2294,7 +2313,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym32", 7) =3D=3D 0)
                 {
 {
...
@@ -2309,7 +2328,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym31", 7) =3D=3D 0)
                 {
 {
...
@@ -2324,7 +2343,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym30", 7) =3D=3D 0)
                 {
 {
...
@@ -2348,7 +2367,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym29", 7) =3D=3D 0)
                 {
 {
...
@@ -2363,7 +2382,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym28", 7) =3D=3D 0)
                 {
 {
...
@@ -2378,7 +2397,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym27", 7) =3D=3D 0)
                 {
 {
...
@@ -2393,7 +2412,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym26", 7) =3D=3D 0)
                 {
 {
...
@@ -2408,7 +2427,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym25", 7) =3D=3D 0)
                 {
 {
...
@@ -2423,7 +2442,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym24", 7) =3D=3D 0)
                 {
 {
...
@@ -2438,7 +2457,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym23", 7) =3D=3D 0)
                 {
 {
...
@@ -2453,7 +2472,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym22", 7) =3D=3D 0)
                 {
 {
...
@@ -2468,7 +2487,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym21", 7) =3D=3D 0)
                 {
 {
...
@@ -2483,7 +2502,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym20", 7) =3D=3D 0)
                 {
 {
...
@@ -2507,7 +2526,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym19", 7) =3D=3D 0)
                 {
 {
...
@@ -2522,7 +2541,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym18", 7) =3D=3D 0)
                 {
 {
...
@@ -2537,7 +2556,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym17", 7) =3D=3D 0)
                 {
 {
...
@@ -2552,7 +2571,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym16", 7) =3D=3D 0)
                 {
 {
...
@@ -2567,7 +2586,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym15", 7) =3D=3D 0)
                 {
 {
...
@@ -2582,7 +2601,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym14", 7) =3D=3D 0)
                 {
 {
...
@@ -2597,7 +2616,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym13", 7) =3D=3D 0)
                 {
 {
-return dev_storage + 733;
+return dev_storage + 737;
...
@@ -2612,7 +2631,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym12", 7) =3D=3D 0)
                 {
 {
-return dev_storage + 732;
+return dev_storage + 736;
...
@@ -2627,7 +2646,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym11", 7) =3D=3D 0)
                 {
 {
-return dev_storage + 731;
+return dev_storage + 735;
...
@@ -2642,7 +2661,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym10", 7) =3D=3D 0)
                 {
 {
-return dev_storage + 730;
+return dev_storage + 734;
...
@@ -2672,7 +2691,7 @@ return	NULL;
           if (strncmp (KR_keyword, "/dev/tty", 8) =3D=3D 0)
             {
 {
...
@@ -2705,7 +2724,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st9", 8) =3D=3D 0)
                 {
 {
...
@@ -2720,7 +2739,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/sr9", 8) =3D=3D 0)
                 {
 {
...
@@ -2735,7 +2754,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/fd9", 8) =3D=3D 0)
                 {
 {
...
@@ -2750,7 +2769,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym119", 8) =3D=3D 0)
                 {
 {
...
@@ -2765,7 +2784,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym109", 8) =3D=3D 0)
                 {
 {
...
@@ -2789,7 +2808,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st8", 8) =3D=3D 0)
                 {
 {
...
@@ -2804,7 +2823,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/sr8", 8) =3D=3D 0)
                 {
 {
...
@@ -2819,7 +2838,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/fd8", 8) =3D=3D 0)
                 {
 {
...
@@ -2834,7 +2853,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym118", 8) =3D=3D 0)
                 {
 {
...
@@ -2849,7 +2868,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym108", 8) =3D=3D 0)
                 {
 {
...
@@ -2873,7 +2892,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st7", 8) =3D=3D 0)
                 {
 {
...
@@ -2888,7 +2907,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/sr7", 8) =3D=3D 0)
                 {
 {
...
@@ -2903,7 +2922,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/fd7", 8) =3D=3D 0)
                 {
 {
...
@@ -2918,7 +2937,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym127", 8) =3D=3D 0)
                 {
 {
...
@@ -2933,7 +2952,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym117", 8) =3D=3D 0)
                 {
 {
...
@@ -2948,7 +2967,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym107", 8) =3D=3D 0)
                 {
 {
...
@@ -2972,7 +2991,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st6", 8) =3D=3D 0)
                 {
 {
...
@@ -2987,7 +3006,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/sr6", 8) =3D=3D 0)
                 {
 {
...
@@ -3002,7 +3021,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/fd6", 8) =3D=3D 0)
                 {
 {
...
@@ -3017,7 +3036,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym126", 8) =3D=3D 0)
                 {
 {
...
@@ -3032,7 +3051,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym116", 8) =3D=3D 0)
                 {
 {
...
@@ -3047,7 +3066,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym106", 8) =3D=3D 0)
                 {
 {
...
@@ -3071,7 +3090,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st5", 8) =3D=3D 0)
                 {
 {
...
@@ -3086,7 +3105,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/sr5", 8) =3D=3D 0)
                 {
 {
...
@@ -3101,7 +3120,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/fd5", 8) =3D=3D 0)
                 {
 {
...
@@ -3116,7 +3135,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym125", 8) =3D=3D 0)
                 {
 {
...
@@ -3131,7 +3150,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym115", 8) =3D=3D 0)
                 {
 {
...
@@ -3146,7 +3165,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym105", 8) =3D=3D 0)
                 {
 {
...
@@ -3170,7 +3189,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st4", 8) =3D=3D 0)
                 {
 {
...
@@ -3185,7 +3204,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/sr4", 8) =3D=3D 0)
                 {
 {
...
@@ -3200,7 +3219,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/fd4", 8) =3D=3D 0)
                 {
 {
...
@@ -3215,7 +3234,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym124", 8) =3D=3D 0)
                 {
 {
...
@@ -3230,7 +3249,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym114", 8) =3D=3D 0)
                 {
 {
...
@@ -3245,7 +3264,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym104", 8) =3D=3D 0)
                 {
 {
...
@@ -3269,7 +3288,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st3", 8) =3D=3D 0)
                 {
 {
...
@@ -3284,7 +3303,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/sr3", 8) =3D=3D 0)
                 {
 {
...
@@ -3299,7 +3318,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/fd3", 8) =3D=3D 0)
                 {
 {
...
@@ -3314,7 +3333,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym123", 8) =3D=3D 0)
                 {
 {
-return dev_storage + 843;
+return dev_storage + 847;
...
@@ -3329,7 +3348,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym113", 8) =3D=3D 0)
                 {
 {
-return dev_storage + 833;
+return dev_storage + 837;
...
@@ -3344,7 +3363,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym103", 8) =3D=3D 0)
                 {
 {
-return dev_storage + 823;
+return dev_storage + 827;
...
@@ -3368,7 +3387,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st2", 8) =3D=3D 0)
                 {
 {
...
@@ -3383,7 +3402,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/sr2", 8) =3D=3D 0)
                 {
 {
...
@@ -3398,7 +3417,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/fd2", 8) =3D=3D 0)
                 {
 {
...
@@ -3413,7 +3432,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym122", 8) =3D=3D 0)
                 {
 {
-return dev_storage + 842;
+return dev_storage + 846;
...
@@ -3428,7 +3447,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym112", 8) =3D=3D 0)
                 {
 {
-return dev_storage + 832;
+return dev_storage + 836;
...
@@ -3443,7 +3462,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym102", 8) =3D=3D 0)
                 {
 {
-return dev_storage + 822;
+return dev_storage + 826;
...
@@ -3467,7 +3486,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st1", 8) =3D=3D 0)
                 {
 {
...
@@ -3482,7 +3501,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/sr1", 8) =3D=3D 0)
                 {
 {
...
@@ -3497,7 +3516,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/fd1", 8) =3D=3D 0)
                 {
 {
...
@@ -3512,7 +3531,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym121", 8) =3D=3D 0)
                 {
 {
-return dev_storage + 841;
+return dev_storage + 845;
...
@@ -3527,7 +3546,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym111", 8) =3D=3D 0)
                 {
 {
-return dev_storage + 831;
+return dev_storage + 835;
...
@@ -3542,7 +3561,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym101", 8) =3D=3D 0)
                 {
 {
-return dev_storage + 821;
+return dev_storage + 825;
...
@@ -3566,7 +3585,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st0", 8) =3D=3D 0)
                 {
 {
...
@@ -3581,7 +3600,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/sr0", 8) =3D=3D 0)
                 {
 {
...
@@ -3596,7 +3615,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/fd0", 8) =3D=3D 0)
                 {
 {
-return dev_storage + 150;
+return dev_storage + 151;
...
@@ -3611,7 +3630,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym120", 8) =3D=3D 0)
                 {
 {
-return dev_storage + 840;
+return dev_storage + 844;
...
@@ -3626,7 +3645,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym110", 8) =3D=3D 0)
                 {
 {
-return dev_storage + 830;
+return dev_storage + 834;
...
@@ -3641,7 +3660,7 @@ return	NULL;
               if (strncmp (KR_keyword, ":ptym100", 8) =3D=3D 0)
                 {
 {
-return dev_storage + 820;
+return dev_storage + 824;
...
@@ -3671,7 +3690,7 @@ return	NULL;
           if (strncmp (KR_keyword, "/dev/ptmx", 9) =3D=3D 0)
             {
 {
...
@@ -3686,7 +3705,7 @@ return	NULL;
           if (strncmp (KR_keyword, "/dev/zero", 9) =3D=3D 0)
             {
 {
...
@@ -3704,7 +3723,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/null", 9) =3D=3D 0)
                 {
 {
...
@@ -3719,7 +3738,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/full", 9) =3D=3D 0)
                 {
 {
...
@@ -3743,7 +3762,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/pty9", 9) =3D=3D 0)
                 {
 {
...
@@ -3758,7 +3777,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/nst9", 9) =3D=3D 0)
                 {
 {
...
@@ -3788,7 +3807,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/scd9", 9) =3D=3D 0)
                 {
 {
...
@@ -3803,7 +3822,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st99", 9) =3D=3D 0)
                 {
 {
...
@@ -3818,7 +3837,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st89", 9) =3D=3D 0)
                 {
 {
...
@@ -3833,7 +3852,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st79", 9) =3D=3D 0)
                 {
 {
...
@@ -3848,7 +3867,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st69", 9) =3D=3D 0)
                 {
 {
...
@@ -3863,7 +3882,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st59", 9) =3D=3D 0)
                 {
 {
...
@@ -3878,7 +3897,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st49", 9) =3D=3D 0)
                 {
 {
...
@@ -3893,7 +3912,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st39", 9) =3D=3D 0)
                 {
 {
...
@@ -3908,7 +3927,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st29", 9) =3D=3D 0)
                 {
 {
...
@@ -3923,7 +3942,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st19", 9) =3D=3D 0)
                 {
 {
...
@@ -3947,7 +3966,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/pty8", 9) =3D=3D 0)
                 {
 {
...
@@ -3962,7 +3981,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/nst8", 9) =3D=3D 0)
                 {
 {
...
@@ -3992,7 +4011,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/scd8", 9) =3D=3D 0)
                 {
 {
...
@@ -4007,7 +4026,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st98", 9) =3D=3D 0)
                 {
 {
...
@@ -4022,7 +4041,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st88", 9) =3D=3D 0)
                 {
 {
...
@@ -4037,7 +4056,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st78", 9) =3D=3D 0)
                 {
 {
...
@@ -4052,7 +4071,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st68", 9) =3D=3D 0)
                 {
 {
...
@@ -4067,7 +4086,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st58", 9) =3D=3D 0)
                 {
 {
...
@@ -4082,7 +4101,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st48", 9) =3D=3D 0)
                 {
 {
...
@@ -4097,7 +4116,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st38", 9) =3D=3D 0)
                 {
 {
...
@@ -4112,7 +4131,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st28", 9) =3D=3D 0)
                 {
 {
...
@@ -4127,7 +4146,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st18", 9) =3D=3D 0)
                 {
 {
...
@@ -4151,7 +4170,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/pty7", 9) =3D=3D 0)
                 {
 {
...
@@ -4166,7 +4185,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/nst7", 9) =3D=3D 0)
                 {
 {
...
@@ -4196,7 +4215,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/scd7", 9) =3D=3D 0)
                 {
 {
...
@@ -4211,7 +4230,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st97", 9) =3D=3D 0)
                 {
 {
...
@@ -4226,7 +4245,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st87", 9) =3D=3D 0)
                 {
 {
...
@@ -4241,7 +4260,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st77", 9) =3D=3D 0)
                 {
 {
...
@@ -4256,7 +4275,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st67", 9) =3D=3D 0)
                 {
 {
...
@@ -4271,7 +4290,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st57", 9) =3D=3D 0)
                 {
 {
...
@@ -4286,7 +4305,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st47", 9) =3D=3D 0)
                 {
 {
...
@@ -4301,7 +4320,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st37", 9) =3D=3D 0)
                 {
 {
...
@@ -4316,7 +4335,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st27", 9) =3D=3D 0)
                 {
 {
...
@@ -4331,7 +4350,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st17", 9) =3D=3D 0)
                 {
 {
...
@@ -4355,7 +4374,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/pty6", 9) =3D=3D 0)
                 {
 {
...
@@ -4370,7 +4389,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/nst6", 9) =3D=3D 0)
                 {
 {
...
@@ -4400,7 +4419,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/scd6", 9) =3D=3D 0)
                 {
 {
...
@@ -4415,7 +4434,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st96", 9) =3D=3D 0)
                 {
 {
...
@@ -4430,7 +4449,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st86", 9) =3D=3D 0)
                 {
 {
...
@@ -4445,7 +4464,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st76", 9) =3D=3D 0)
                 {
 {
...
@@ -4460,7 +4479,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st66", 9) =3D=3D 0)
                 {
 {
...
@@ -4475,7 +4494,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st56", 9) =3D=3D 0)
                 {
 {
...
@@ -4490,7 +4509,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st46", 9) =3D=3D 0)
                 {
 {
...
@@ -4505,7 +4524,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st36", 9) =3D=3D 0)
                 {
 {
...
@@ -4520,7 +4539,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st26", 9) =3D=3D 0)
                 {
 {
...
@@ -4535,7 +4554,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st16", 9) =3D=3D 0)
                 {
 {
...
@@ -4559,7 +4578,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/pty5", 9) =3D=3D 0)
                 {
 {
...
@@ -4574,7 +4593,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/nst5", 9) =3D=3D 0)
                 {
 {
...
@@ -4604,7 +4623,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/scd5", 9) =3D=3D 0)
                 {
 {
...
@@ -4619,7 +4638,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st95", 9) =3D=3D 0)
                 {
 {
...
@@ -4634,7 +4653,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st85", 9) =3D=3D 0)
                 {
 {
...
@@ -4649,7 +4668,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st75", 9) =3D=3D 0)
                 {
 {
...
@@ -4664,7 +4683,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st65", 9) =3D=3D 0)
                 {
 {
...
@@ -4679,7 +4698,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st55", 9) =3D=3D 0)
                 {
 {
...
@@ -4694,7 +4713,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st45", 9) =3D=3D 0)
                 {
 {
...
@@ -4709,7 +4728,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st35", 9) =3D=3D 0)
                 {
 {
...
@@ -4724,7 +4743,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st25", 9) =3D=3D 0)
                 {
 {
...
@@ -4742,7 +4761,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/st15", 9) =3D=3D 0)
                     {
 {
...
@@ -4757,7 +4776,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/sr15", 9) =3D=3D 0)
                     {
 {
...
@@ -4772,7 +4791,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/fd15", 9) =3D=3D 0)
                     {
 {
...
@@ -4802,7 +4821,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/pty4", 9) =3D=3D 0)
                 {
 {
...
@@ -4817,7 +4836,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/nst4", 9) =3D=3D 0)
                 {
 {
...
@@ -4847,7 +4866,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/scd4", 9) =3D=3D 0)
                 {
 {
...
@@ -4862,7 +4881,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st94", 9) =3D=3D 0)
                 {
 {
...
@@ -4877,7 +4896,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st84", 9) =3D=3D 0)
                 {
 {
...
@@ -4892,7 +4911,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st74", 9) =3D=3D 0)
                 {
 {
...
@@ -4907,7 +4926,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st64", 9) =3D=3D 0)
                 {
 {
...
@@ -4922,7 +4941,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st54", 9) =3D=3D 0)
                 {
 {
...
@@ -4937,7 +4956,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st44", 9) =3D=3D 0)
                 {
 {
...
@@ -4952,7 +4971,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st34", 9) =3D=3D 0)
                 {
 {
...
@@ -4967,7 +4986,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st24", 9) =3D=3D 0)
                 {
 {
...
@@ -4985,7 +5004,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/st14", 9) =3D=3D 0)
                     {
 {
...
@@ -5000,7 +5019,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/sr14", 9) =3D=3D 0)
                     {
 {
...
@@ -5015,7 +5034,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/fd14", 9) =3D=3D 0)
                     {
 {
...
@@ -5045,7 +5064,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/pty3", 9) =3D=3D 0)
                 {
 {
...
@@ -5060,7 +5079,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/nst3", 9) =3D=3D 0)
                 {
 {
...
@@ -5090,7 +5109,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/scd3", 9) =3D=3D 0)
                 {
 {
...
@@ -5105,7 +5124,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st93", 9) =3D=3D 0)
                 {
 {
...
@@ -5120,7 +5139,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st83", 9) =3D=3D 0)
                 {
 {
...
@@ -5135,7 +5154,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st73", 9) =3D=3D 0)
                 {
 {
...
@@ -5150,7 +5169,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st63", 9) =3D=3D 0)
                 {
 {
...
@@ -5165,7 +5184,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st53", 9) =3D=3D 0)
                 {
 {
...
@@ -5180,7 +5199,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st43", 9) =3D=3D 0)
                 {
 {
...
@@ -5195,7 +5214,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st33", 9) =3D=3D 0)
                 {
 {
...
@@ -5210,7 +5229,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st23", 9) =3D=3D 0)
                 {
 {
...
@@ -5228,7 +5247,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/st13", 9) =3D=3D 0)
                     {
 {
...
@@ -5243,7 +5262,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/sr13", 9) =3D=3D 0)
                     {
 {
...
@@ -5258,7 +5277,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/fd13", 9) =3D=3D 0)
                     {
 {
...
@@ -5288,7 +5307,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/pty2", 9) =3D=3D 0)
                 {
 {
...
@@ -5303,7 +5322,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/nst2", 9) =3D=3D 0)
                 {
 {
...
@@ -5333,7 +5352,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/scd2", 9) =3D=3D 0)
                 {
 {
...
@@ -5348,7 +5367,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st92", 9) =3D=3D 0)
                 {
 {
...
@@ -5363,7 +5382,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st82", 9) =3D=3D 0)
                 {
 {
...
@@ -5378,7 +5397,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st72", 9) =3D=3D 0)
                 {
 {
...
@@ -5393,7 +5412,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st62", 9) =3D=3D 0)
                 {
 {
...
@@ -5408,7 +5427,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st52", 9) =3D=3D 0)
                 {
 {
...
@@ -5423,7 +5442,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st42", 9) =3D=3D 0)
                 {
 {
...
@@ -5438,7 +5457,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st32", 9) =3D=3D 0)
                 {
 {
...
@@ -5453,7 +5472,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st22", 9) =3D=3D 0)
                 {
 {
...
@@ -5471,7 +5490,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/st12", 9) =3D=3D 0)
                     {
 {
...
@@ -5486,7 +5505,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/sr12", 9) =3D=3D 0)
                     {
 {
...
@@ -5501,7 +5520,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/fd12", 9) =3D=3D 0)
                     {
 {
...
@@ -5531,7 +5550,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/pty1", 9) =3D=3D 0)
                 {
 {
...
@@ -5546,7 +5565,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/nst1", 9) =3D=3D 0)
                 {
 {
...
@@ -5576,7 +5595,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/scd1", 9) =3D=3D 0)
                 {
 {
...
@@ -5591,7 +5610,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st91", 9) =3D=3D 0)
                 {
 {
...
@@ -5606,7 +5625,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st81", 9) =3D=3D 0)
                 {
 {
...
@@ -5621,7 +5640,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st71", 9) =3D=3D 0)
                 {
 {
...
@@ -5636,7 +5655,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st61", 9) =3D=3D 0)
                 {
 {
...
@@ -5651,7 +5670,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st51", 9) =3D=3D 0)
                 {
 {
...
@@ -5666,7 +5685,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st41", 9) =3D=3D 0)
                 {
 {
...
@@ -5681,7 +5700,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st31", 9) =3D=3D 0)
                 {
 {
...
@@ -5696,7 +5715,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st21", 9) =3D=3D 0)
                 {
 {
...
@@ -5714,7 +5733,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/st11", 9) =3D=3D 0)
                     {
 {
...
@@ -5729,7 +5748,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/sr11", 9) =3D=3D 0)
                     {
 {
...
@@ -5744,7 +5763,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/fd11", 9) =3D=3D 0)
                     {
 {
...
@@ -5774,7 +5793,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/pty0", 9) =3D=3D 0)
                 {
 {
-return dev_storage + 297;
+return dev_storage + 298;
...
@@ -5789,7 +5808,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/nst0", 9) =3D=3D 0)
                 {
 {
-return dev_storage + 167;
+return dev_storage + 168;
...
@@ -5804,7 +5823,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/scd0", 9) =3D=3D 0)
                 {
 {
...
@@ -5819,7 +5838,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st90", 9) =3D=3D 0)
                 {
 {
-return dev_storage + 548;
+return dev_storage + 549;
...
@@ -5834,7 +5853,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st80", 9) =3D=3D 0)
                 {
 {
-return dev_storage + 538;
+return dev_storage + 539;
...
@@ -5849,7 +5868,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st70", 9) =3D=3D 0)
                 {
 {
-return dev_storage + 528;
+return dev_storage + 529;
...
@@ -5864,7 +5883,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st60", 9) =3D=3D 0)
                 {
 {
-return dev_storage + 518;
+return dev_storage + 519;
...
@@ -5879,7 +5898,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st50", 9) =3D=3D 0)
                 {
 {
-return dev_storage + 508;
+return dev_storage + 509;
...
@@ -5894,7 +5913,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st40", 9) =3D=3D 0)
                 {
 {
-return dev_storage + 498;
+return dev_storage + 499;
...
@@ -5909,7 +5928,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st30", 9) =3D=3D 0)
                 {
 {
-return dev_storage + 488;
+return dev_storage + 489;
...
@@ -5924,7 +5943,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st20", 9) =3D=3D 0)
                 {
 {
-return dev_storage + 478;
+return dev_storage + 479;
...
@@ -5942,7 +5961,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/st10", 9) =3D=3D 0)
                     {
 {
-return dev_storage + 468;
+return dev_storage + 469;
...
@@ -5957,7 +5976,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/sr10", 9) =3D=3D 0)
                     {
 {
-return dev_storage + 452;
+return dev_storage + 453;
...
@@ -5972,7 +5991,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/fd10", 9) =3D=3D 0)
                     {
 {
-return dev_storage + 160;
+return dev_storage + 161;
...
@@ -6164,15 +6183,39 @@ return	NULL;
         ...
         case 'i':
-          if (strncmp (KR_keyword, "/dev/conin", 10) =3D=3D 0)
+          switch (KR_keyword [5])
             {
+            case 's':
+              if (strncmp (KR_keyword, "/dev/stdin", 10) =3D=3D 0)
+                {
+{
...
@@ -6185,7 +6228,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/ttyS9", 10) =3D=3D 0)
                 {
 {
...
@@ -6200,7 +6243,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/ttyS8", 10) =3D=3D 0)
                 {
 {
...
@@ -6215,7 +6258,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/ttyS7", 10) =3D=3D 0)
                 {
 {
...
@@ -6230,7 +6273,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/ttyS6", 10) =3D=3D 0)
                 {
 {
...
@@ -6245,7 +6288,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/ttyS5", 10) =3D=3D 0)
                 {
 {
...
@@ -6260,7 +6303,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/ttyS4", 10) =3D=3D 0)
                 {
 {
...
@@ -6275,7 +6318,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/ttyS3", 10) =3D=3D 0)
                 {
 {
-return dev_storage + 590;
+return dev_storage + 594;
...
@@ -6290,7 +6333,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/ttyS2", 10) =3D=3D 0)
                 {
 {
...
@@ -6305,7 +6348,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/ttyS1", 10) =3D=3D 0)
                 {
 {
-return dev_storage + 588;
+return dev_storage + 592;
...
@@ -6320,7 +6363,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/ttyS0", 10) =3D=3D 0)
                 {
 {
...
@@ -6347,7 +6390,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty99", 10) =3D=3D 0)
                     {
 {
...
@@ -6362,7 +6405,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty98", 10) =3D=3D 0)
                     {
 {
...
@@ -6377,7 +6420,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty97", 10) =3D=3D 0)
                     {
 {
...
@@ -6392,7 +6435,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty96", 10) =3D=3D 0)
                     {
 {
...
@@ -6407,7 +6450,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty95", 10) =3D=3D 0)
                     {
 {
...
@@ -6422,7 +6465,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty94", 10) =3D=3D 0)
                     {
 {
...
@@ -6437,7 +6480,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty93", 10) =3D=3D 0)
                     {
 {
...
@@ -6452,7 +6495,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty92", 10) =3D=3D 0)
                     {
 {
...
@@ -6467,7 +6510,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty91", 10) =3D=3D 0)
                     {
 {
...
@@ -6482,7 +6525,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty90", 10) =3D=3D 0)
                     {
 {
...
@@ -6506,7 +6549,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst99", 10) =3D=3D 0)
                     {
 {
...
@@ -6521,7 +6564,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst98", 10) =3D=3D 0)
                     {
 {
...
@@ -6536,7 +6579,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst97", 10) =3D=3D 0)
                     {
 {
...
@@ -6551,7 +6594,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst96", 10) =3D=3D 0)
                     {
 {
...
@@ -6566,7 +6609,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst95", 10) =3D=3D 0)
                     {
 {
...
@@ -6581,7 +6624,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst94", 10) =3D=3D 0)
                     {
 {
...
@@ -6596,7 +6639,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst93", 10) =3D=3D 0)
                     {
 {
...
@@ -6611,7 +6654,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst92", 10) =3D=3D 0)
                     {
 {
...
@@ -6626,7 +6669,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst91", 10) =3D=3D 0)
                     {
 {
...
@@ -6641,7 +6684,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst90", 10) =3D=3D 0)
                     {
 {
...
@@ -6674,7 +6717,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty89", 10) =3D=3D 0)
                     {
 {
...
@@ -6689,7 +6732,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty88", 10) =3D=3D 0)
                     {
 {
...
@@ -6704,7 +6747,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty87", 10) =3D=3D 0)
                     {
 {
...
@@ -6719,7 +6762,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty86", 10) =3D=3D 0)
                     {
 {
...
@@ -6734,7 +6777,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty85", 10) =3D=3D 0)
                     {
 {
...
@@ -6749,7 +6792,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty84", 10) =3D=3D 0)
                     {
 {
...
@@ -6764,7 +6807,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty83", 10) =3D=3D 0)
                     {
 {
...
@@ -6779,7 +6822,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty82", 10) =3D=3D 0)
                     {
 {
...
@@ -6794,7 +6837,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty81", 10) =3D=3D 0)
                     {
 {
...
@@ -6809,7 +6852,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty80", 10) =3D=3D 0)
                     {
 {
...
@@ -6833,7 +6876,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst89", 10) =3D=3D 0)
                     {
 {
...
@@ -6848,7 +6891,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst88", 10) =3D=3D 0)
                     {
 {
...
@@ -6863,7 +6906,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst87", 10) =3D=3D 0)
                     {
 {
...
@@ -6878,7 +6921,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst86", 10) =3D=3D 0)
                     {
 {
...
@@ -6893,7 +6936,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst85", 10) =3D=3D 0)
                     {
 {
...
@@ -6908,7 +6951,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst84", 10) =3D=3D 0)
                     {
 {
...
@@ -6923,7 +6966,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst83", 10) =3D=3D 0)
                     {
 {
...
@@ -6938,7 +6981,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst82", 10) =3D=3D 0)
                     {
 {
...
@@ -6953,7 +6996,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst81", 10) =3D=3D 0)
                     {
 {
...
@@ -6968,7 +7011,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst80", 10) =3D=3D 0)
                     {
 {
...
@@ -7001,7 +7044,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty79", 10) =3D=3D 0)
                     {
 {
...
@@ -7016,7 +7059,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty78", 10) =3D=3D 0)
                     {
 {
...
@@ -7031,7 +7074,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty77", 10) =3D=3D 0)
                     {
 {
...
@@ -7046,7 +7089,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty76", 10) =3D=3D 0)
                     {
 {
...
@@ -7061,7 +7104,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty75", 10) =3D=3D 0)
                     {
 {
...
@@ -7076,7 +7119,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty74", 10) =3D=3D 0)
                     {
 {
...
@@ -7091,7 +7134,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty73", 10) =3D=3D 0)
                     {
 {
...
@@ -7106,7 +7149,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty72", 10) =3D=3D 0)
                     {
 {
...
@@ -7121,7 +7164,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty71", 10) =3D=3D 0)
                     {
 {
...
@@ -7136,7 +7179,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty70", 10) =3D=3D 0)
                     {
 {
...
@@ -7160,7 +7203,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst79", 10) =3D=3D 0)
                     {
 {
...
@@ -7175,7 +7218,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst78", 10) =3D=3D 0)
                     {
 {
...
@@ -7190,7 +7233,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst77", 10) =3D=3D 0)
                     {
 {
...
@@ -7205,7 +7248,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst76", 10) =3D=3D 0)
                     {
 {
...
@@ -7220,7 +7263,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst75", 10) =3D=3D 0)
                     {
 {
...
@@ -7235,7 +7278,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst74", 10) =3D=3D 0)
                     {
 {
...
@@ -7250,7 +7293,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst73", 10) =3D=3D 0)
                     {
 {
...
@@ -7265,7 +7308,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst72", 10) =3D=3D 0)
                     {
 {
...
@@ -7280,7 +7323,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst71", 10) =3D=3D 0)
                     {
 {
...
@@ -7295,7 +7338,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst70", 10) =3D=3D 0)
                     {
 {
...
@@ -7328,7 +7371,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty69", 10) =3D=3D 0)
                     {
 {
...
@@ -7343,7 +7386,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty68", 10) =3D=3D 0)
                     {
 {
...
@@ -7358,7 +7401,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty67", 10) =3D=3D 0)
                     {
 {
...
@@ -7373,7 +7416,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty66", 10) =3D=3D 0)
                     {
 {
...
@@ -7388,7 +7431,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty65", 10) =3D=3D 0)
                     {
 {
...
@@ -7403,7 +7446,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty64", 10) =3D=3D 0)
                     {
 {
...
@@ -7418,7 +7461,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty63", 10) =3D=3D 0)
                     {
 {
...
@@ -7433,7 +7476,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty62", 10) =3D=3D 0)
                     {
 {
...
@@ -7448,7 +7491,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty61", 10) =3D=3D 0)
                     {
 {
...
@@ -7463,7 +7506,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty60", 10) =3D=3D 0)
                     {
 {
...
@@ -7487,7 +7530,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst69", 10) =3D=3D 0)
                     {
 {
...
@@ -7502,7 +7545,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst68", 10) =3D=3D 0)
                     {
 {
...
@@ -7517,7 +7560,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst67", 10) =3D=3D 0)
                     {
 {
...
@@ -7532,7 +7575,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst66", 10) =3D=3D 0)
                     {
 {
...
@@ -7547,7 +7590,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst65", 10) =3D=3D 0)
                     {
 {
...
@@ -7562,7 +7605,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst64", 10) =3D=3D 0)
                     {
 {
...
@@ -7577,7 +7620,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst63", 10) =3D=3D 0)
                     {
 {
...
@@ -7592,7 +7635,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst62", 10) =3D=3D 0)
                     {
 {
...
@@ -7607,7 +7650,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst61", 10) =3D=3D 0)
                     {
 {
...
@@ -7622,7 +7665,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst60", 10) =3D=3D 0)
                     {
 {
...
@@ -7655,7 +7698,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty59", 10) =3D=3D 0)
                     {
 {
...
@@ -7670,7 +7713,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty58", 10) =3D=3D 0)
                     {
 {
...
@@ -7685,7 +7728,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty57", 10) =3D=3D 0)
                     {
 {
...
@@ -7700,7 +7743,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty56", 10) =3D=3D 0)
                     {
 {
...
@@ -7715,7 +7758,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty55", 10) =3D=3D 0)
                     {
 {
...
@@ -7730,7 +7773,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty54", 10) =3D=3D 0)
                     {
 {
...
@@ -7745,7 +7788,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty53", 10) =3D=3D 0)
                     {
 {
...
@@ -7760,7 +7803,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty52", 10) =3D=3D 0)
                     {
 {
...
@@ -7775,7 +7818,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty51", 10) =3D=3D 0)
                     {
 {
...
@@ -7790,7 +7833,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty50", 10) =3D=3D 0)
                     {
 {
...
@@ -7814,7 +7857,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst59", 10) =3D=3D 0)
                     {
 {
...
@@ -7829,7 +7872,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst58", 10) =3D=3D 0)
                     {
 {
...
@@ -7844,7 +7887,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst57", 10) =3D=3D 0)
                     {
 {
...
@@ -7859,7 +7902,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst56", 10) =3D=3D 0)
                     {
 {
...
@@ -7874,7 +7917,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst55", 10) =3D=3D 0)
                     {
 {
...
@@ -7889,7 +7932,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst54", 10) =3D=3D 0)
                     {
 {
...
@@ -7904,7 +7947,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst53", 10) =3D=3D 0)
                     {
 {
...
@@ -7919,7 +7962,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst52", 10) =3D=3D 0)
                     {
 {
...
@@ -7934,7 +7977,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst51", 10) =3D=3D 0)
                     {
 {
...
@@ -7949,7 +7992,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst50", 10) =3D=3D 0)
                     {
 {
...
@@ -7982,7 +8025,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty49", 10) =3D=3D 0)
                     {
 {
...
@@ -7997,7 +8040,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty48", 10) =3D=3D 0)
                     {
 {
...
@@ -8012,7 +8055,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty47", 10) =3D=3D 0)
                     {
 {
...
@@ -8027,7 +8070,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty46", 10) =3D=3D 0)
                     {
 {
...
@@ -8042,7 +8085,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty45", 10) =3D=3D 0)
                     {
 {
...
@@ -8057,7 +8100,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty44", 10) =3D=3D 0)
                     {
 {
...
@@ -8072,7 +8115,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty43", 10) =3D=3D 0)
                     {
 {
...
@@ -8087,7 +8130,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty42", 10) =3D=3D 0)
                     {
 {
...
@@ -8102,7 +8145,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty41", 10) =3D=3D 0)
                     {
 {
...
@@ -8117,7 +8160,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty40", 10) =3D=3D 0)
                     {
 {
...
@@ -8141,7 +8184,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst49", 10) =3D=3D 0)
                     {
 {
...
@@ -8156,7 +8199,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst48", 10) =3D=3D 0)
                     {
 {
...
@@ -8171,7 +8214,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst47", 10) =3D=3D 0)
                     {
 {
...
@@ -8186,7 +8229,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst46", 10) =3D=3D 0)
                     {
 {
...
@@ -8201,7 +8244,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst45", 10) =3D=3D 0)
                     {
 {
...
@@ -8216,7 +8259,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst44", 10) =3D=3D 0)
                     {
 {
...
@@ -8231,7 +8274,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst43", 10) =3D=3D 0)
                     {
 {
...
@@ -8246,7 +8289,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst42", 10) =3D=3D 0)
                     {
 {
...
@@ -8261,7 +8304,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst41", 10) =3D=3D 0)
                     {
 {
...
@@ -8276,7 +8319,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst40", 10) =3D=3D 0)
                     {
 {
...
@@ -8309,7 +8352,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty39", 10) =3D=3D 0)
                     {
 {
...
@@ -8324,7 +8367,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty38", 10) =3D=3D 0)
                     {
 {
...
@@ -8339,7 +8382,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty37", 10) =3D=3D 0)
                     {
 {
...
@@ -8354,7 +8397,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty36", 10) =3D=3D 0)
                     {
 {
...
@@ -8369,7 +8412,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty35", 10) =3D=3D 0)
                     {
 {
...
@@ -8384,7 +8427,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty34", 10) =3D=3D 0)
                     {
 {
...
@@ -8399,7 +8442,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty33", 10) =3D=3D 0)
                     {
 {
...
@@ -8414,7 +8457,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty32", 10) =3D=3D 0)
                     {
 {
...
@@ -8429,7 +8472,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty31", 10) =3D=3D 0)
                     {
 {
...
@@ -8444,7 +8487,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty30", 10) =3D=3D 0)
                     {
 {
...
@@ -8468,7 +8511,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst39", 10) =3D=3D 0)
                     {
 {
...
@@ -8483,7 +8526,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst38", 10) =3D=3D 0)
                     {
 {
...
@@ -8498,7 +8541,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst37", 10) =3D=3D 0)
                     {
 {
...
@@ -8513,7 +8556,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst36", 10) =3D=3D 0)
                     {
 {
...
@@ -8528,7 +8571,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst35", 10) =3D=3D 0)
                     {
 {
...
@@ -8543,7 +8586,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst34", 10) =3D=3D 0)
                     {
 {
...
@@ -8558,7 +8601,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst33", 10) =3D=3D 0)
                     {
 {
...
@@ -8573,7 +8616,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst32", 10) =3D=3D 0)
                     {
 {
...
@@ -8588,7 +8631,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst31", 10) =3D=3D 0)
                     {
 {
...
@@ -8603,7 +8646,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst30", 10) =3D=3D 0)
                     {
 {
...
@@ -8636,7 +8679,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/st127", 10) =3D=3D 0)
                     {
 {
...
@@ -8651,7 +8694,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/st126", 10) =3D=3D 0)
                     {
 {
...
@@ -8666,7 +8709,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/st125", 10) =3D=3D 0)
                     {
 {
...
@@ -8681,7 +8724,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/st124", 10) =3D=3D 0)
                     {
 {
...
@@ -8696,7 +8739,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/st123", 10) =3D=3D 0)
                     {
 {
...
@@ -8711,7 +8754,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/st122", 10) =3D=3D 0)
                     {
 {
...
@@ -8726,7 +8769,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/st121", 10) =3D=3D 0)
                     {
 {
...
@@ -8741,7 +8784,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/st120", 10) =3D=3D 0)
                     {
 {
...
@@ -8765,7 +8808,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty29", 10) =3D=3D 0)
                     {
 {
...
@@ -8780,7 +8823,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty28", 10) =3D=3D 0)
                     {
 {
...
@@ -8795,7 +8838,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty27", 10) =3D=3D 0)
                     {
 {
...
@@ -8810,7 +8853,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty26", 10) =3D=3D 0)
                     {
 {
...
@@ -8825,7 +8868,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty25", 10) =3D=3D 0)
                     {
 {
...
@@ -8840,7 +8883,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty24", 10) =3D=3D 0)
                     {
 {
...
@@ -8855,7 +8898,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty23", 10) =3D=3D 0)
                     {
 {
...
@@ -8870,7 +8913,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty22", 10) =3D=3D 0)
                     {
 {
...
@@ -8885,7 +8928,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty21", 10) =3D=3D 0)
                     {
 {
...
@@ -8900,7 +8943,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty20", 10) =3D=3D 0)
                     {
 {
...
@@ -8924,7 +8967,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst29", 10) =3D=3D 0)
                     {
 {
...
@@ -8939,7 +8982,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst28", 10) =3D=3D 0)
                     {
 {
...
@@ -8954,7 +8997,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst27", 10) =3D=3D 0)
                     {
 {
...
@@ -8969,7 +9012,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst26", 10) =3D=3D 0)
                     {
 {
...
@@ -8984,7 +9027,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst25", 10) =3D=3D 0)
                     {
 {
...
@@ -8999,7 +9042,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst24", 10) =3D=3D 0)
                     {
 {
...
@@ -9014,7 +9057,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst23", 10) =3D=3D 0)
                     {
 {
...
@@ -9029,7 +9072,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst22", 10) =3D=3D 0)
                     {
 {
...
@@ -9044,7 +9087,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst21", 10) =3D=3D 0)
                     {
 {
...
@@ -9059,7 +9102,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst20", 10) =3D=3D 0)
                     {
 {
...
@@ -9092,7 +9135,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty19", 10) =3D=3D 0)
                     {
 {
...
@@ -9107,7 +9150,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty18", 10) =3D=3D 0)
                     {
 {
...
@@ -9122,7 +9165,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty17", 10) =3D=3D 0)
                     {
 {
...
@@ -9137,7 +9180,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty16", 10) =3D=3D 0)
                     {
 {
...
@@ -9152,7 +9195,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty15", 10) =3D=3D 0)
                     {
 {
...
@@ -9167,7 +9210,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty14", 10) =3D=3D 0)
                     {
 {
...
@@ -9182,7 +9225,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty13", 10) =3D=3D 0)
                     {
 {
...
@@ -9197,7 +9240,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty12", 10) =3D=3D 0)
                     {
 {
...
@@ -9212,7 +9255,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty11", 10) =3D=3D 0)
                     {
 {
...
@@ -9227,7 +9270,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty10", 10) =3D=3D 0)
                     {
 {
-return dev_storage + 307;
+return dev_storage + 308;
...
@@ -9251,7 +9294,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst19", 10) =3D=3D 0)
                     {
 {
...
@@ -9266,7 +9309,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst18", 10) =3D=3D 0)
                     {
 {
...
@@ -9281,7 +9324,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst17", 10) =3D=3D 0)
                     {
 {
...
@@ -9296,7 +9339,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst16", 10) =3D=3D 0)
                     {
 {
...
@@ -9311,7 +9354,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst15", 10) =3D=3D 0)
                     {
 {
...
@@ -9326,7 +9369,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst14", 10) =3D=3D 0)
                     {
 {
...
@@ -9341,7 +9384,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst13", 10) =3D=3D 0)
                     {
 {
...
@@ -9356,7 +9399,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst12", 10) =3D=3D 0)
                     {
 {
...
@@ -9371,7 +9414,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst11", 10) =3D=3D 0)
                     {
 {
...
@@ -9386,7 +9429,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst10", 10) =3D=3D 0)
                     {
 {
-return dev_storage + 177;
+return dev_storage + 178;
...
@@ -9524,7 +9567,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/scd15", 10) =3D=3D 0)
                     {
 {
...
@@ -9539,7 +9582,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/scd14", 10) =3D=3D 0)
                     {
 {
...
@@ -9554,7 +9597,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/scd13", 10) =3D=3D 0)
                     {
 {
...
@@ -9569,7 +9612,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/scd12", 10) =3D=3D 0)
                     {
 {
...
@@ -9584,7 +9627,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/scd11", 10) =3D=3D 0)
                     {
 {
...
@@ -9599,7 +9642,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/scd10", 10) =3D=3D 0)
                     {
 {
-return dev_storage + 436;
+return dev_storage + 437;
...
@@ -9623,7 +9666,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/st119", 10) =3D=3D 0)
                     {
 {
...
@@ -9638,7 +9681,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/st118", 10) =3D=3D 0)
                     {
 {
...
@@ -9653,7 +9696,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/st117", 10) =3D=3D 0)
                     {
 {
...
@@ -9668,7 +9711,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/st116", 10) =3D=3D 0)
                     {
 {
...
@@ -9683,7 +9726,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/st115", 10) =3D=3D 0)
                     {
 {
...
@@ -9698,7 +9741,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/st114", 10) =3D=3D 0)
                     {
 {
...
@@ -9713,7 +9756,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/st113", 10) =3D=3D 0)
                     {
 {
...
@@ -9728,7 +9771,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/st112", 10) =3D=3D 0)
                     {
 {
...
@@ -9743,7 +9786,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/st111", 10) =3D=3D 0)
                     {
 {
...
@@ -9758,7 +9801,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/st110", 10) =3D=3D 0)
                     {
 {
...
@@ -9788,7 +9831,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st109", 10) =3D=3D 0)
                 {
 {
...
@@ -9803,7 +9846,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st108", 10) =3D=3D 0)
                 {
 {
...
@@ -9818,7 +9861,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st107", 10) =3D=3D 0)
                 {
 {
...
@@ -9833,7 +9876,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st106", 10) =3D=3D 0)
                 {
 {
...
@@ -9848,7 +9891,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st105", 10) =3D=3D 0)
                 {
 {
...
@@ -9863,7 +9906,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st104", 10) =3D=3D 0)
                 {
 {
...
@@ -9878,7 +9921,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st103", 10) =3D=3D 0)
                 {
 {
...
@@ -9893,7 +9936,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st102", 10) =3D=3D 0)
                 {
 {
...
@@ -9908,7 +9951,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st101", 10) =3D=3D 0)
                 {
 {
...
@@ -9923,7 +9966,7 @@ return	NULL;
               if (strncmp (KR_keyword, "/dev/st100", 10) =3D=3D 0)
                 {
 {
-return dev_storage + 558;
+return dev_storage + 559;
...
@@ -9950,11 +9993,50 @@ return	NULL;
       switch (KR_keyword [9])
         {
         case 'u':
-          if (strncmp (KR_keyword, "/dev/conout", 11) =3D=3D 0)
+          switch (KR_keyword [5])
             {
+            case 's':
+              if (strncmp (KR_keyword, "/dev/stdout", 11) =3D=3D 0)
+                {
+{
+return dev_storage + 589;
+
...
+            }
+        case 'r':
+          if (strncmp (KR_keyword, "/dev/stderr", 11) =3D=3D 0)
+            {
+{
+return dev_storage + 587;
+
...
@@ -9968,7 +10050,7 @@ return	NULL;
           if (strncmp (KR_keyword, "/dev/random", 11) =3D=3D 0)
             {
 {
...
@@ -9989,7 +10071,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS99", 11) =3D=3D 0)
                     {
 {
...
@@ -10004,7 +10086,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS98", 11) =3D=3D 0)
                     {
 {
...
@@ -10019,7 +10101,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS97", 11) =3D=3D 0)
                     {
 {
...
@@ -10034,7 +10116,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS96", 11) =3D=3D 0)
                     {
 {
...
@@ -10049,7 +10131,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS95", 11) =3D=3D 0)
                     {
 {
...
@@ -10064,7 +10146,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS94", 11) =3D=3D 0)
                     {
 {
...
@@ -10079,7 +10161,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS93", 11) =3D=3D 0)
                     {
 {
...
@@ -10094,7 +10176,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS92", 11) =3D=3D 0)
                     {
 {
...
@@ -10109,7 +10191,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS91", 11) =3D=3D 0)
                     {
 {
...
@@ -10124,7 +10206,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS90", 11) =3D=3D 0)
                     {
 {
...
@@ -10316,7 +10398,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS89", 11) =3D=3D 0)
                     {
 {
...
@@ -10331,7 +10413,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS88", 11) =3D=3D 0)
                     {
 {
...
@@ -10346,7 +10428,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS87", 11) =3D=3D 0)
                     {
 {
...
@@ -10361,7 +10443,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS86", 11) =3D=3D 0)
                     {
 {
...
@@ -10376,7 +10458,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS85", 11) =3D=3D 0)
                     {
 {
...
@@ -10391,7 +10473,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS84", 11) =3D=3D 0)
                     {
 {
...
@@ -10406,7 +10488,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS83", 11) =3D=3D 0)
                     {
 {
...
@@ -10421,7 +10503,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS82", 11) =3D=3D 0)
                     {
 {
...
@@ -10436,7 +10518,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS81", 11) =3D=3D 0)
                     {
 {
...
@@ -10451,7 +10533,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS80", 11) =3D=3D 0)
                     {
 {
...
@@ -10643,7 +10725,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS79", 11) =3D=3D 0)
                     {
 {
...
@@ -10658,7 +10740,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS78", 11) =3D=3D 0)
                     {
 {
...
@@ -10673,7 +10755,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS77", 11) =3D=3D 0)
                     {
 {
...
@@ -10688,7 +10770,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS76", 11) =3D=3D 0)
                     {
 {
...
@@ -10703,7 +10785,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS75", 11) =3D=3D 0)
                     {
 {
...
@@ -10718,7 +10800,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS74", 11) =3D=3D 0)
                     {
 {
...
@@ -10733,7 +10815,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS73", 11) =3D=3D 0)
                     {
 {
...
@@ -10748,7 +10830,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS72", 11) =3D=3D 0)
                     {
 {
...
@@ -10763,7 +10845,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS71", 11) =3D=3D 0)
                     {
 {
...
@@ -10778,7 +10860,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS70", 11) =3D=3D 0)
                     {
 {
...
@@ -10970,7 +11052,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS69", 11) =3D=3D 0)
                     {
 {
...
@@ -10985,7 +11067,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS68", 11) =3D=3D 0)
                     {
 {
...
@@ -11000,7 +11082,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS67", 11) =3D=3D 0)
                     {
 {
...
@@ -11015,7 +11097,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS66", 11) =3D=3D 0)
                     {
 {
...
@@ -11030,7 +11112,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS65", 11) =3D=3D 0)
                     {
 {
...
@@ -11045,7 +11127,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS64", 11) =3D=3D 0)
                     {
 {
...
@@ -11060,7 +11142,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS63", 11) =3D=3D 0)
                     {
 {
...
@@ -11075,7 +11157,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS62", 11) =3D=3D 0)
                     {
 {
...
@@ -11090,7 +11172,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS61", 11) =3D=3D 0)
                     {
 {
...
@@ -11105,7 +11187,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS60", 11) =3D=3D 0)
                     {
 {
...
@@ -11297,7 +11379,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS59", 11) =3D=3D 0)
                     {
 {
...
@@ -11312,7 +11394,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS58", 11) =3D=3D 0)
                     {
 {
...
@@ -11327,7 +11409,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS57", 11) =3D=3D 0)
                     {
 {
...
@@ -11342,7 +11424,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS56", 11) =3D=3D 0)
                     {
 {
...
@@ -11357,7 +11439,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS55", 11) =3D=3D 0)
                     {
 {
...
@@ -11372,7 +11454,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS54", 11) =3D=3D 0)
                     {
 {
...
@@ -11387,7 +11469,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS53", 11) =3D=3D 0)
                     {
 {
...
@@ -11402,7 +11484,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS52", 11) =3D=3D 0)
                     {
 {
...
@@ -11417,7 +11499,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS51", 11) =3D=3D 0)
                     {
 {
...
@@ -11432,7 +11514,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS50", 11) =3D=3D 0)
                     {
 {
...
@@ -11624,7 +11706,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS49", 11) =3D=3D 0)
                     {
 {
...
@@ -11639,7 +11721,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS48", 11) =3D=3D 0)
                     {
 {
...
@@ -11654,7 +11736,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS47", 11) =3D=3D 0)
                     {
 {
...
@@ -11669,7 +11751,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS46", 11) =3D=3D 0)
                     {
 {
...
@@ -11684,7 +11766,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS45", 11) =3D=3D 0)
                     {
 {
...
@@ -11699,7 +11781,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS44", 11) =3D=3D 0)
                     {
 {
...
@@ -11714,7 +11796,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS43", 11) =3D=3D 0)
                     {
 {
...
@@ -11729,7 +11811,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS42", 11) =3D=3D 0)
                     {
 {
...
@@ -11744,7 +11826,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS41", 11) =3D=3D 0)
                     {
 {
...
@@ -11759,7 +11841,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS40", 11) =3D=3D 0)
                     {
 {
...
@@ -11951,7 +12033,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS39", 11) =3D=3D 0)
                     {
 {
...
@@ -11966,7 +12048,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS38", 11) =3D=3D 0)
                     {
 {
...
@@ -11981,7 +12063,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS37", 11) =3D=3D 0)
                     {
 {
...
@@ -11996,7 +12078,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS36", 11) =3D=3D 0)
                     {
 {
...
@@ -12011,7 +12093,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS35", 11) =3D=3D 0)
                     {
 {
...
@@ -12026,7 +12108,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS34", 11) =3D=3D 0)
                     {
 {
...
@@ -12041,7 +12123,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS33", 11) =3D=3D 0)
                     {
 {
...
@@ -12056,7 +12138,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS32", 11) =3D=3D 0)
                     {
 {
...
@@ -12071,7 +12153,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS31", 11) =3D=3D 0)
                     {
 {
...
@@ -12086,7 +12168,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS30", 11) =3D=3D 0)
                     {
 {
...
@@ -12278,7 +12360,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS29", 11) =3D=3D 0)
                     {
 {
...
@@ -12293,7 +12375,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS28", 11) =3D=3D 0)
                     {
 {
...
@@ -12308,7 +12390,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS27", 11) =3D=3D 0)
                     {
 {
...
@@ -12323,7 +12405,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS26", 11) =3D=3D 0)
                     {
 {
...
@@ -12338,7 +12420,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS25", 11) =3D=3D 0)
                     {
 {
...
@@ -12353,7 +12435,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS24", 11) =3D=3D 0)
                     {
 {
...
@@ -12368,7 +12450,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS23", 11) =3D=3D 0)
                     {
 {
...
@@ -12383,7 +12465,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS22", 11) =3D=3D 0)
                     {
 {
...
@@ -12398,7 +12480,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS21", 11) =3D=3D 0)
                     {
 {
...
@@ -12413,7 +12495,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS20", 11) =3D=3D 0)
                     {
 {
...
@@ -12437,7 +12519,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty127", 11) =3D=3D 0)
                     {
 {
...
@@ -12452,7 +12534,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty126", 11) =3D=3D 0)
                     {
 {
...
@@ -12467,7 +12549,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty125", 11) =3D=3D 0)
                     {
 {
...
@@ -12482,7 +12564,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty124", 11) =3D=3D 0)
                     {
 {
...
@@ -12497,7 +12579,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty123", 11) =3D=3D 0)
                     {
 {
...
@@ -12512,7 +12594,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty122", 11) =3D=3D 0)
                     {
 {
...
@@ -12527,7 +12609,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty121", 11) =3D=3D 0)
                     {
 {
...
@@ -12542,7 +12624,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty120", 11) =3D=3D 0)
                     {
 {
...
@@ -12566,7 +12648,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst127", 11) =3D=3D 0)
                     {
 {
...
@@ -12581,7 +12663,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst126", 11) =3D=3D 0)
                     {
 {
...
@@ -12596,7 +12678,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst125", 11) =3D=3D 0)
                     {
 {
...
@@ -12611,7 +12693,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst124", 11) =3D=3D 0)
                     {
 {
...
@@ -12626,7 +12708,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst123", 11) =3D=3D 0)
                     {
 {
...
@@ -12641,7 +12723,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst122", 11) =3D=3D 0)
                     {
 {
...
@@ -12656,7 +12738,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst121", 11) =3D=3D 0)
                     {
 {
...
@@ -12671,7 +12753,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst120", 11) =3D=3D 0)
                     {
 {
...
@@ -12863,7 +12945,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS19", 11) =3D=3D 0)
                     {
 {
...
@@ -12878,7 +12960,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS18", 11) =3D=3D 0)
                     {
 {
...
@@ -12893,7 +12975,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS17", 11) =3D=3D 0)
                     {
 {
...
@@ -12908,7 +12990,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS16", 11) =3D=3D 0)
                     {
 {
...
@@ -12923,7 +13005,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS15", 11) =3D=3D 0)
                     {
 {
...
@@ -12938,7 +13020,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS14", 11) =3D=3D 0)
                     {
 {
...
@@ -12953,7 +13035,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS13", 11) =3D=3D 0)
                     {
 {
-return dev_storage + 600;
+return dev_storage + 604;
...
@@ -12968,7 +13050,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS12", 11) =3D=3D 0)
                     {
 {
-return dev_storage + 599;
+return dev_storage + 603;
...
@@ -12983,7 +13065,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS11", 11) =3D=3D 0)
                     {
 {
-return dev_storage + 598;
+return dev_storage + 602;
...
@@ -12998,7 +13080,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS10", 11) =3D=3D 0)
                     {
 {
-return dev_storage + 597;
+return dev_storage + 601;
...
@@ -13022,7 +13104,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty119", 11) =3D=3D 0)
                     {
 {
...
@@ -13037,7 +13119,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty118", 11) =3D=3D 0)
                     {
 {
...
@@ -13052,7 +13134,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty117", 11) =3D=3D 0)
                     {
 {
...
@@ -13067,7 +13149,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty116", 11) =3D=3D 0)
                     {
 {
...
@@ -13082,7 +13164,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty115", 11) =3D=3D 0)
                     {
 {
...
@@ -13097,7 +13179,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty114", 11) =3D=3D 0)
                     {
 {
...
@@ -13112,7 +13194,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty113", 11) =3D=3D 0)
                     {
 {
...
@@ -13127,7 +13209,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty112", 11) =3D=3D 0)
                     {
 {
...
@@ -13142,7 +13224,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty111", 11) =3D=3D 0)
                     {
 {
...
@@ -13157,7 +13239,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty110", 11) =3D=3D 0)
                     {
 {
...
@@ -13181,7 +13263,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst119", 11) =3D=3D 0)
                     {
 {
...
@@ -13196,7 +13278,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst118", 11) =3D=3D 0)
                     {
 {
...
@@ -13211,7 +13293,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst117", 11) =3D=3D 0)
                     {
 {
...
@@ -13226,7 +13308,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst116", 11) =3D=3D 0)
                     {
 {
...
@@ -13241,7 +13323,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst115", 11) =3D=3D 0)
                     {
 {
...
@@ -13256,7 +13338,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst114", 11) =3D=3D 0)
                     {
 {
...
@@ -13271,7 +13353,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst113", 11) =3D=3D 0)
                     {
 {
...
@@ -13286,7 +13368,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst112", 11) =3D=3D 0)
                     {
 {
...
@@ -13301,7 +13383,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst111", 11) =3D=3D 0)
                     {
 {
...
@@ -13316,7 +13398,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst110", 11) =3D=3D 0)
                     {
 {
...
@@ -13508,7 +13590,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty109", 11) =3D=3D 0)
                     {
 {
...
@@ -13523,7 +13605,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty108", 11) =3D=3D 0)
                     {
 {
...
@@ -13538,7 +13620,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty107", 11) =3D=3D 0)
                     {
 {
...
@@ -13553,7 +13635,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty106", 11) =3D=3D 0)
                     {
 {
...
@@ -13568,7 +13650,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty105", 11) =3D=3D 0)
                     {
 {
...
@@ -13583,7 +13665,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty104", 11) =3D=3D 0)
                     {
 {
...
@@ -13598,7 +13680,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty103", 11) =3D=3D 0)
                     {
 {
...
@@ -13613,7 +13695,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty102", 11) =3D=3D 0)
                     {
 {
...
@@ -13628,7 +13710,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty101", 11) =3D=3D 0)
                     {
 {
...
@@ -13643,7 +13725,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/pty100", 11) =3D=3D 0)
                     {
 {
-return dev_storage + 397;
+return dev_storage + 398;
...
@@ -13667,7 +13749,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst109", 11) =3D=3D 0)
                     {
 {
...
@@ -13682,7 +13764,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst108", 11) =3D=3D 0)
                     {
 {
...
@@ -13697,7 +13779,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst107", 11) =3D=3D 0)
                     {
 {
...
@@ -13712,7 +13794,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst106", 11) =3D=3D 0)
                     {
 {
...
@@ -13727,7 +13809,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst105", 11) =3D=3D 0)
                     {
 {
...
@@ -13742,7 +13824,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst104", 11) =3D=3D 0)
                     {
 {
...
@@ -13757,7 +13839,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst103", 11) =3D=3D 0)
                     {
 {
...
@@ -13772,7 +13854,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst102", 11) =3D=3D 0)
                     {
 {
...
@@ -13787,7 +13869,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst101", 11) =3D=3D 0)
                     {
 {
...
@@ -13802,7 +13884,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/nst100", 11) =3D=3D 0)
                     {
 {
-return dev_storage + 267;
+return dev_storage + 268;
...
@@ -13838,7 +13920,7 @@ return	NULL;
           if (strncmp (KR_keyword, "/dev/windows", 12) =3D=3D 0)
             {
 {
...
@@ -13853,7 +13935,7 @@ return	NULL;
           if (strncmp (KR_keyword, "/dev/urandom", 12) =3D=3D 0)
             {
 {
...
@@ -13889,7 +13971,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS127", 12) =3D=3D 0)
                     {
 {
...
@@ -13904,7 +13986,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS126", 12) =3D=3D 0)
                     {
 {
...
@@ -13919,7 +14001,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS125", 12) =3D=3D 0)
                     {
 {
...
@@ -13934,7 +14016,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS124", 12) =3D=3D 0)
                     {
 {
...
@@ -13949,7 +14031,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS123", 12) =3D=3D 0)
                     {
 {
...
@@ -13964,7 +14046,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS122", 12) =3D=3D 0)
                     {
 {
...
@@ -13979,7 +14061,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS121", 12) =3D=3D 0)
                     {
 {
...
@@ -13994,7 +14076,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS120", 12) =3D=3D 0)
                     {
 {
...
@@ -14156,7 +14238,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS119", 12) =3D=3D 0)
                     {
 {
...
@@ -14171,7 +14253,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS118", 12) =3D=3D 0)
                     {
 {
...
@@ -14186,7 +14268,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS117", 12) =3D=3D 0)
                     {
 {
...
@@ -14201,7 +14283,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS116", 12) =3D=3D 0)
                     {
 {
...
@@ -14216,7 +14298,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS115", 12) =3D=3D 0)
                     {
 {
...
@@ -14231,7 +14313,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS114", 12) =3D=3D 0)
                     {
 {
...
@@ -14246,7 +14328,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS113", 12) =3D=3D 0)
                     {
 {
...
@@ -14261,7 +14343,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS112", 12) =3D=3D 0)
                     {
 {
...
@@ -14276,7 +14358,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS111", 12) =3D=3D 0)
                     {
 {
...
@@ -14291,7 +14373,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS110", 12) =3D=3D 0)
                     {
 {
...
@@ -14483,7 +14565,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS109", 12) =3D=3D 0)
                     {
 {
...
@@ -14498,7 +14580,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS108", 12) =3D=3D 0)
                     {
 {
...
@@ -14513,7 +14595,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS107", 12) =3D=3D 0)
                     {
 {
...
@@ -14528,7 +14610,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS106", 12) =3D=3D 0)
                     {
 {
...
@@ -14543,7 +14625,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS105", 12) =3D=3D 0)
                     {
 {
...
@@ -14558,7 +14640,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS104", 12) =3D=3D 0)
                     {
 {
...
@@ -14573,7 +14655,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS103", 12) =3D=3D 0)
                     {
 {
-return dev_storage + 690;
+return dev_storage + 694;
...
@@ -14588,7 +14670,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS102", 12) =3D=3D 0)
                     {
 {
-return dev_storage + 689;
+return dev_storage + 693;
...
@@ -14603,7 +14685,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS101", 12) =3D=3D 0)
                     {
 {
-return dev_storage + 688;
+return dev_storage + 692;
...
@@ -14618,7 +14700,7 @@ return	NULL;
                   if (strncmp (KR_keyword, "/dev/ttyS100", 12) =3D=3D 0)
                     {
 {
-return dev_storage + 687;
+return dev_storage + 691;
