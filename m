Return-Path: <cygwin-patches-return-9171-listarch-cygwin-patches=sources.redhat.com@cygwin.com>
Received: (qmail 3923 invoked by alias); 15 Aug 2018 11:00:01 -0000
...
Received: (qmail 3897 invoked by uid 89); 15 Aug 2018 11:00:00 -0000
Authentication-Results: sourceware.org; auth=none
X-Spam-SWARE-Status: No, score=-24.4 required=5.0 tests=AWL,BAYES_00,GIT_PATCH_0,GIT_PATCH_1,GIT_PATCH_2,GIT_PATCH_3,RCVD_IN_DNSWL_NONE,SPF_PASS autolearn=ham version=3.3.2 spammy=william, William, H*F:D*nl, H*Ad:D*nl
X-HELO: lb2-smtp-cloud9.xs4all.net
Received: from lb2-smtp-cloud9.xs4all.net (HELO lb2-smtp-cloud9.xs4all.net) (194.109.24.26) by sourceware.org (qpsmtpd/0.93/v0.84-503-g423c35a) with ESMTP; Wed, 15 Aug 2018 10:59:57 +0000
Received: from frodo.localdomain ([83.162.234.136])	by smtp-cloud9.xs4all.net with ESMTPA	id ptWrfk6vsEJtcptWsfUIch; Wed, 15 Aug 2018 12:59:55 +0200
From: "J.H. van de Water" <houder@xs4all.nl>
To: cygwin-patches@cygwin.com
Cc: "J.H. van de Water" <houder@xs4all.nl>
Subject: [PATCH 1/1] Keep the denormal-operand exception masked; modify FE_ALL_EXCEPT accordingly.
Date: Wed, 15 Aug 2018 11:00:00 -0000
Message-Id: <1534330763-2755-1-git-send-email-houder@xs4all.nl>
X-IsSubscribed: yes
X-SW-Source: 2018-q3/txt/msg00066.txt.bz2
